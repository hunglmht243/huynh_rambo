  ...
  <?php //}?> 
    ...
    <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" id="noidung_thongbaoakditmemay"><h3 style="text-align: justify;"><strong><span style="color: #ff00ff;">Chào mừng bạn đến với <?=strtoupper($_SERVER['SERVER_NAME']);?>.</span></strong></h3>
...
<p style="text-align: center;"><span style="color: #800000;"><em><strong></strong></em></span></p></div>
                    </div>
                </div>
                    ...
                    $.when(
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                //console.log(data);
                                data.forEach((data) => {
                                            body+=`<div class="panel-body turn`+(data['ma_game'] == currentTab ? ' active' : '')+`" turn-tab="`+data['ma_game']+`" style="padding-top: 0px;">`+data['mo_ta']+`
            ...
            font-size: 9px;"><font color="green">`+Intl.NumberFormat().format(ds_phone[key].today)+`</font>/<font color="6861b1">30M</font>|<font color="green">`+ds_phone[key].today_gd+`</font>/<font color="6861b1">150</font></b></b> <span style="margin-left: 11px" class="label label-success text-uppercase" onclick="coppy('`+key+`',`+ds_phone[key].min+`,`+ds_phone[key].max+`)"><i class="fa fa-clipboard" aria-hidden="true"></i></span> </td>
               ...
               // Object.keys(setting).foreach((key) => {  
                    for (let key in setting) {                 
                            ...
                            body+=`<tr>
                            <td>
                                <span class="fa-stack"><span class="fa fa-circle fa-stack-2x dot-text-`+k+`"> </span><span class="fa-stack-1x text-white" id=""><b>`+key+`</b></span></span>
                            </td>
                            <td> `;
                            // i = 0;
                            // kq = ;
