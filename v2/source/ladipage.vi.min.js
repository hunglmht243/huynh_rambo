...
var Base64 = {
    ...
    encode: function(t) {
        ...
        for (t = Base64._utf8_encode(t); d < t.length; )
            ...
            o = (3 & e) << 4 | (i = t.charCodeAt(d++)) >> 4,
            r = (15 & i) << 2 | (a = t.charCodeAt(d++)) >> 6,
            s = 63 & a,
            isNaN(i) ? r = s = 64 : isNaN(a) && (s = 64),
            l = l + Base64._keyStr.charAt(n) + Base64._keyStr.charAt(o) + Base64._keyStr.charAt(r) + Base64._keyStr.charAt(s);
        return l
    },
    decode: function(t) {
    ...
    var l = function(n) {
        ...
        i == a.length && function(t) {
            for (var i = [], a = document.querySelectorAll("div.ladi-section-global[data-country-file]"), n = 0; n < a.length; n++) {
                ...
                e.isEmpty(o) || (o = (o = o.split(";")).removeSpace(),
                i = i.concat(o))
            }
    ...
    a.forEach(function(t) {
        ...
        e.sendRequest("GET", o, null, !0, null, function(o, r, s) {
            if (s.readyState == XMLHttpRequest.DONE) {
                ...
                d.innerHTML = o,
                LadiPageScript.isEmpty(d.querySelector('div.ladi-section-global[data-id="' + t.id + '"] .ladi-section[data-global-id="' + t.data_global_id + '"]')) ? n.parentElement.removeChild(n) : n.outerHTML = o,
                function(t) {
                    i++;
...
LadiPageScriptV2.prototype.updateHeightElement = function(t, e, i, a, n, o, r) {
    var s = this
      , l = [];
    if ("fixed" != getComputedStyle(e).position) {
        for (var d = [], c = e.parentElement.children, p = 0; p < c.length; p++)
            c[p].id != e.id && c[p].classList.contains("ladi-element") && d.push(c[p]);
        ...
        for (var _ = function(t) {
            ...
            if ((e = e ? t.id != s.runtime.builder_section_popup_id : e) && "fixed" == getComputedStyle(t).position && (!t.classList.contains("ladi-element") || 0 == t.getElementsByClassName("ladi-popup").length) && (e = !1,
            t.classList.contains("ladi-section"))) {
            ...
            if (_(d[h])) {
                ...
                v >= g + a && (o && (d[h].classList.add("transition-parent-collapse-top"),
                f(d[h])),
                d[h].style.setProperty("top", (parseFloatLadiPage(v + y) || 0) + "px"),
                l.push(d[h].id))
            }
        var E = 0
          , P = 0;
        if (!this.isEmpty(i) && 0 != y && _(i) && (E = parseFloatLadiPage(getComputedStyle(i).height) || 0,
        P = parseFloatLadiPage(E + y) || 0,
        o && (i.classList.add("transition-parent-collapse-height"),
        s.runTimeout(function() {
        ...
        E != P) {
            ...
            this.isEmpty(L) && (L = this.findAncestor(i.parentElement, "ladi-section")),
            l = l.concat(this.updateHeightElement(!1, i, L, E, P, o, r))
        }
...
LadiPageScriptV2.prototype.showParentVisibility = function(t, e) {
    ...
    if (!this.isEmpty(i) && (i = this.findAncestor(i, "ladi-element"),
    !this.isEmpty(i)))
    ...
    if (!a.isEmpty(n)) {
        ...
        if (e == a.const.VIDEO_TYPE.youtube) {
            ...
            if (a.runtime.isYouTubeIframeAPIReady) {
                ...
                if (!a.isEmpty(d)) {
                    if (s && i && a.isFunction(d.unMute) && d.unMute(),
        ...
        a.isEmpty(r) || r.style.removeProperty("display")) : (n.classList.add("ladi-hidden"),
...
LadiPageScriptV2.prototype.runEventPlayVideo = function(t, e, i, a, n, o, r, s, l, d) {
    ...
    var u = function(t, i) {
        if (p && !t.hasAttribute("data-remove-button-unmute")) {
            var a = t.id + "_button_unmute"
              , n = document.getElementById(a);
            c.isEmpty(n) && ((n = document.createElement("div")).id = a,
            n.innerHTML = "<div></div>",
            ...
            n.addEventListener("click", function(i) {
                ...
                e == c.const.VIDEO_TYPE.youtube) {
                    ...
                    if (c.runtime.isYouTubeIframeAPIReady) {
                        ...
                        !c.isEmpty(o) && c.isFunction(o.unMute) && (o.unMute(),
                        a = !0)
                    }
            ...
            c.isEmpty(o) || (n.style.setProperty("width", getComputedStyle(t).width),
    ...
    if (!c.isEmpty(m)) {
        ...
        !a || o || c.isEmpty(_) || (_.classList.add("pointer-events-none"),
        ...
        if (e == c.const.VIDEO_TYPE.youtube) {
            var h = c.getVideoId(e, i)
              , v = function() {
                try {
                    if (c.runtime.isLoadYouTubeIframeAPI && c.runtime.isYouTubeIframeAPIReady || !c.isObject(window.YT) || !c.isFunction(window.YT.Player) || (c.runtime.isLoadYouTubeIframeAPI = !0,
                    ...
                    var e = function() {
                      ...
                      , _ = function(e) {
                        ...
                        c.isEmpty(i) || c.isEmpty(m) ? c.runTimeout(_, 100) : (c.runResizeAll(),
                        a || p ? i.mute() : i.unMute(),
                        r || s || i.playVideo(),
                        c.isFunction(d) && d(),
                        u(m))
    ...
    if (!this.isEmpty(r)) {
        ...
        this.isEmpty(s)) {
            var l = r.getElementsByClassName("ladi-video")[0]
              , d = t + "_player";
            e == this.const.VIDEO_TYPE.youtube && (l.innerHTML = l.innerHTML + '<iframe id="' + d + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
            this.runEventPlayVideo(d, e, i, n, !1, a, o)),
            e == this.const.VIDEO_TYPE.direct && (l.innerHTML = l.innerHTML + '<video id="' + d + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; object-fit: cover;"></video>',
            this.runEventPlayVideo(d, e, i, n, !1, a, o))
        } else
            this.runEventReplayVideo(s.id, e, !0)
    }
}
,
...
LadiPageScriptV2.prototype.getOptimizeImage = function(t, e, i, a, n, o, r) {
    if (this.isEmpty(t) || !this.isString(t))
        return t;
    var s = t.split("/")
      , l = s.indexOf("");
    if (-1 != l && s.length > l + 1 && (s[l + 1] = s[l + 1].toLowerCase()),
        ...
        if (!this.isEmpty(i)) {
            ...
            if (0 != n.length) {
                ...
                var d = function(i, a) {
                  ...
                  , c = function() {
                    if (e.is_autoplay) {
                        var i = 300
                          , a = null;
                        if (t.isEmpty(t.runtime.tmp.current_default_popup_id) && !t.runtime.tmp.story_page_mouse_down && !t.runtime.tmp.story_page_scroll && (a = document.querySelector(".ladi-story-page-progress-bar-item span"),
                        !t.isEmpty(a))) {
                ...
                i.addEventListener("scroll", function(a) {
                    t.isEmpty(t.runtime.tmp.current_default_popup_id) && (t.runtime.tmp.story_page_scroll = !0,
        ...
        for (var e = document.querySelectorAll(".ladi-section .ladi-section-background iframe.ladi-section-background-video"), i = 0; i < e.length; i++) {
            ...
            if (!(n <= 0 || o <= 0)) {
                var r = t.findAncestor(a, "ladi-section-background")
                  , s = r.clientWidth
                  , l = o / n * s;
                l < r.clientHeight && (s = r.clientHeight / l * s,
                l = r.clientHeight);
...
LadiPageScriptV2.prototype.runResizeAll = function() {
    ...
    try {
        ...
        for (var e = document.querySelectorAll("#" + t.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), i = 0; i < e.length; i++)
            "none" != getComputedStyle(e[i]).display && window.ladi(e[i].id).show(!0);
...
LadiPageScriptV2.prototype.runEventResize = function(t) {
    ...
    e.isEmpty(e.runtime.tmp.timeoutResizeAll) || e.removeTimeout(e.runtime.tmp.timeoutResizeAll),
        ...
        if (t && e.isObject(e.runtime.story_page)) {
            ...
            for (var s = document.querySelectorAll(".ladi-gallery .ladi-gallery-view-item.selected:not(.ladi-lazyload)"), l = 0; l < s.length; l++)
                if (e.isEmpty(s[l].getAttribute("data-lazyload"))) {
                    ...
                    for (var d = s[l].parentElement.getElementsByClassName("ladi-lazyload"); d.length > 0; )
...
LadiPageScriptV2.prototype.documentLoaded = function() {
    ...
    try {
        ...
        if (!t.isEmpty(r) && !t.isEmpty(s)) {
            ...
            t.isArray(s.dynamic_content.scroll) && s.dynamic_content.scroll.length > 0 && (o = "#" + s.dynamic_content.scroll.pop())
        }
    } catch (t) {}
    var c = null
      , p = [];
    ...
    p.length > 0 && !t.isEmpty(o))
        try {
            ...
            t.isEmpty(c) || t.isEmpty(c.id) || !c.classList.contains("ladi-section") || (window.ladi(c.id).scroll(!1, !0),
            o = null)
        } catch (t) {}
    ...
    !t.isEmpty(o))
        try {
            c = document.querySelector(o),
            t.isEmpty(c) || t.isEmpty(c.id) || t.runTimeout(function() {
    ...
    t.isEmpty(g) || g.parentElement.removeChild(g),
    t.reloadLazyload(!1)
}
,
...
LadiPageScriptV2.prototype.getURLSearchParams = function(t, e, i) {
    var a = this
      , n = {}
      , o = this.isNull(t);
    if (t = o ? window.location.search : t,
    !this.isEmpty(t))
            ...
            if (this.isNull(n[l[0]])) {
                ...
                try {
                    if (i) {
                        ...
                        Number.isInteger(d) || (n[l[0]] = d,
                        0 == n[l[0]].length ? n[l[0]] = "" : 1 == n[l[0]].length && (n[l[0]] = n[l[0]][0]))
                    }
                } catch (t) {}
            } else
                i && (this.isArray(n[l[0]]) || (n[l[0]] = [n[l[0]]]),
                1 == l.length ? n[l[0]].push("") : n[l[0]].push(decodeURIComponentLadiPage(l[1].replace(/\+/g, " "))))
        }
    ...
    var r = this
      , s = function(l) {
        var d = l[e]
          , c = function(l, p) {
            if (d.list.length <= l)
                0 == l ? s({}) : r.isFunction(o) && o(r.const.LANG.REQUEST_SEND_ERROR, 0, p, e);
            else {
                var u = {};
                u.timeout = d.timeout,
...
LadiPageScriptV2.prototype.sendRequestWithOption = function(t, e, i, a, n, o, r) {
    ...
    if (this.isFunction(this.runtime.send_request_response[e]) && this.runtime.send_request_response[e](e, i, r))
        return;
...
LadiPageScriptV2.prototype.runEventBackdropPopupClick = function(t) {
    ...
    if (!e.isEmpty(i)) {
        ...
        if (!e.isEmpty(o) && "none" == getComputedStyle(o).display)
            return
    }
...
LadiPageScriptV2.prototype.runEventMouseMove = function(t) {
    ...
    e.isEmpty(e.runtime.current_element_mouse_down_gallery_control) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_control + '"]'),
...
LadiPageScriptV2.prototype.runEventMouseUp = function(t) {
    ...
    if (e.isEmpty(e.runtime.current_element_mouse_down_gallery_view) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_view + '"]')).querySelectorAll(".ladi-gallery-view-item.selected").length > 0 && i.querySelectorAll(".ladi-gallery-view-item.selected")[0].style.removeProperty("left"),
...
LadiPageScriptV2.prototype.runEventMouseLeave = function(t) {
    ...
    Object.keys(e.runtime.eventData).forEach(function(t) {
        ...
        if ("popup" == i.type && i["option.show_popup_exit_page"]) {
            if (e.isObject(e.runtime.tmp.popup_leave_show) || (e.runtime.tmp.popup_leave_show = {}),
...
LadiPageScriptV2.prototype.runEventScroll = function(t) {
    ...
    e.runtime.isRun) {
        if (!e.isEmpty(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
            ...
            var o = [];
            if (!e.isEmpty(i))
                for (var r = document.querySelectorAll("#" + i + " .ladi-element"), s = 0; s < r.length; s++)
                    o.push(r[s].id);
            if (Object.keys(e.runtime.eventData).forEach(function(t) {
                ...
                for (var c = 0; c < d.length; c++)
                    ...
                    !e.isEmpty(s)) {
                        ...
                        if (-1 != l.indexOf(p)) {
                            var u = !1;
                            "section" == a.type ? (n = s.offsetTop,
                            (window.scrollY >= n && window.scrollY <= n + s.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + s.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (u = !0)) : (n = e.getElementBoundingClientRect(s).y + window.scrollY,
                            (window.scrollY >= n && window.scrollY <= n + s.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= n && window.scrollY + e.getHeightDevice(!0) <= n + s.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= n) && (u = !0)),
                            u && (r = e.runtime.list_scroll_func[p],
                            delete e.runtime.list_scroll_func[p],
                            r())
                        }
                    }
                var m = a[e.runtime.device + ".style.animation-name"];
                if (!e.isEmpty(m) && (s = document.getElementById(t),
                !e.isEmpty(s) && !s.classList.contains("ladi-animation"))) {
                    ...
                    e.runtime.tmp.isFirstScroll && _ > 0 && s.classList.add("ladi-animation-hidden"),
                    y && (s.classList.add("ladi-animation"),
                    e.runTimeout(function() {
                ...
                if (e.isEmpty(i) || -1 != o.indexOf(t)) {
                    var g = null
                      , f = null
                      , h = null;
                    if (a[e.runtime.device + ".option.sticky"] && (g = a[e.runtime.device + ".option.sticky_position"],
                    ...
                    !e.runtime.has_popupx && !e.isEmpty(g)) {
                        ...
                        if (!e.isEmpty(v) && v.clientWidth > 0 && v.clientHeight > 0 && -1 != ["default", "top", "bottom"].indexOf(g)) {
                            ...
                            e.isEmpty(P) ? (v.setAttribute("data-top", E.y + window.scrollY),
                            P = E.y) : P = parseFloatLadiPage(P),
                            e.isEmpty(L) ? (v.setAttribute("data-left", E.x + window.scrollX),
                            L = E.x) : L = parseFloatLadiPage(L);
                            var A = null
                              , b = null
                              , w = e.getHeightDevice()
                              ...
                              , C = 0
                              , N = 0;
                            if ("default" == g && (f >= P - window.scrollY ? (A = f + "px",
                            b = L + "px",
                            f <= 0 && (T = v.clientHeight),
                            C = v.clientHeight) : w - h - v.clientHeight <= P - window.scrollY && (A = "calc(100% - " + (h + v.clientHeight) + "px)",
                            b = L + "px",
                            h <= 0 && (O = v.clientHeight),
                            N = v.clientHeight)),
                            "top" == g && (f >= P - window.scrollY || w - 0 < P - window.scrollY) && (A = f + "px",
                            b = L + "px",
                            f <= 0 && (T = v.clientHeight),
                            C = v.clientHeight),
                            "bottom" == g && (w - h - v.clientHeight <= P - window.scrollY || 0 > P + v.clientHeight - window.scrollY) && (A = "calc(100% - " + (h + v.clientHeight) + "px)",
                            b = L + "px",
                            h <= 0 && (O = v.clientHeight),
                            N = v.clientHeight),
                            e.isEmpty(A) || e.isEmpty(b))
                                ...
                                S.getAttribute("data-padding-top-id") == t && (S.removeAttribute("data-padding-top-id"),
                                S.style.removeProperty("padding-top")),
                                S.getAttribute("data-padding-bottom-id") == t && (S.removeAttribute("data-padding-bottom-id"),
                                S.style.removeProperty("padding-bottom"));
                            else if ("section" == a.type && (e.runtime.is_mobile_only ? v.style.setProperty("width", S.clientWidth + "px") : e.runtime.isDesktop && v.style.setProperty("width", "100%"),
                            T > 0 && (S.setAttribute("data-padding-top-id", t),
                            S.style.setProperty("padding-top", T + "px")),
                            O > 0 && (S.setAttribute("data-padding-bottom-id", t),
                            ...
                            !v.hasAttribute("data-sticky")) {
                                ...
                                v.classList.contains("ladi-animation-hidden") && (v.classList.remove("ladi-animation-hidden"),
                                v.classList.add("ladi-animation"));
                                for (var I = v.getElementsByClassName("ladi-animation-hidden"); I.length > 0; )
                                    I[0].classList.add("ladi-animation"),
                                    I[0].classList.remove("ladi-animation-hidden");
                                v.classList.remove("ladi-lazyload");
                                for (var k = v.getElementsByClassName("ladi-lazyload"); k.length > 0; )
                                    k[0].classList.remove("ladi-lazyload")
                            }
                        }
                    }
                }
                if ("popup" == a.type) {
                    if (!e.isEmpty(e.runtime.scroll_show_popup[t]))
                        return;
                    e.isEmpty(a["option.popup_welcome_page_scroll_to"]) || (s = document.getElementById(a["option.popup_welcome_page_scroll_to"]),
                    !e.isEmpty(s) && s.offsetHeight > 0 && (n = s.offsetTop,
                    (window.scrollY >= n && window.scrollY <= n + s.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + s.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (e.runtime.scroll_show_popup[t] = !0,
                    window.ladi(t).show())))
                }
                if ("section" == a.type) {
                    ...
                    e.isEmpty(s) || (n = s.offsetTop,
                    (window.scrollY >= n && window.scrollY <= n + s.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + s.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (e.runtime.scroll_to_section[t] = !0,
            ...
            e.runtime.isClient) {
                if (e.runtime.is_popupx)
                    return;
                for (var l = Math.round((window.scrollY + e.getHeightDevice()) / document.body.clientHeight * 100), d = 1; d < e.const.PERCENT_TRACKING_SCROLL.length; d++)
                    l > e.const.PERCENT_TRACKING_SCROLL[d - 1] && l <= e.const.PERCENT_TRACKING_SCROLL[d] && -1 == e.runtime.scroll_depth.indexOf(e.const.PERCENT_TRACKING_SCROLL[d]) && (e.runtime.scroll_depth.push(e.const.PERCENT_TRACKING_SCROLL[d]),
                    e.isFunction(window.gtag) && window.gtag("event", "ScrollDepth_" + e.const.PERCENT_TRACKING_SCROLL[d] + "_percent", {
            ...
            !e.isEmpty(t)) {
                ...
                e.runtime.tmp.timeout_scrolling_id = e.runTimeout(function() {
                    ...
                    p = Object.values(e.runtime.list_scrolled_exec),
                    c = 0; c < p.length; c++)
                        p[c]()
                }, 1e3)
            }
...
LadiPageScriptV2.prototype.runRemovePopup = function(t, e, i, a, n) {
    ...
    if (c.forEach(function(t) {
        ...
        if (!o.isEmpty(i)) {
            ...
            o.isEmpty(n) || (a = parseFloatLadiPage(n.getAttribute("data-timeout-id")) || null,
            o.removeTimeout(a),
            ...
            if (o.isObject(p) && p[o.runtime.device + ".option.popup_position"] == o.const.POSITION_TYPE.default && (c = !0),
            c) {
                d(),
                e && (o.isEmpty(o.runtime.tmp.bodyScrollY) || window.scrollTo(0, o.runtime.tmp.bodyScrollY)),
    ...
    if (!r.isEmpty(e)) {
        ...
        if (!n || !r.isEmpty(s) && r.isObject(r.runtime.eventData) && !r.isEmpty(r.runtime.eventData[e])) {
            ...
            var d = function(t) {
                ...
                r.isEmpty(a) ? p += n ? "#" + r.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + r.runtime.backdrop_popup_id + " { display: block !important;}" : (p += "#" + r.runtime.backdrop_popup_id + " { display: block !important; " + a + "}",
                s.setAttribute("data-popup-backdrop", !0)),
                i == r.const.POSITION_TYPE.default && "true" != s.getAttribute("data-dropbox") && (!function() {
                    if (!r.runtime.has_popupx && n) {
                        ...
                        "block" != s.style.getPropertyValue("display") || r.isEmpty(r.runtime.tmp.bodyScrollY) || (t = r.runtime.tmp.bodyScrollY),
                        p += "body {",
                ...
                "block" != getComputedStyle(s).display && s.style.setProperty("display", "block", "important"),
                v = r.runTimeout(function() {
                    s.classList.remove("ladi-animation-hidden"),
                    s.removeAttribute("data-timeout-id")
                }, h),
                r.isEmpty(v) || s.setAttribute("data-timeout-id", v),
                t && (!m && s.clientHeight > .8 * r.getHeightDevice() && (n ? r.runtime.has_popupx ? y = !0 : (s.setAttribute("data-scroll", !0),
                s.style.setProperty("overflow-y", "auto", "important"),
                s.style.setProperty("overflow-x", "hidden", "important"),
                m = !0) : _ = !0),
                r.runtime.has_popupx && (y ? (s.setAttribute("data-fixed-close", !0),
                document.body.style.setProperty("height", s.clientHeight + "px")) : document.body.style.removeProperty("height")),
                m && n && (s.getElementsByClassName("ladi-popup")[0].style.removeProperty("height"),
                ...
                r.runtime.has_popupx && (p += n ? "#" + r.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + r.runtime.backdrop_popup_id + " { display: block !important;}",
                s.style.removeProperty("max-height"),
                ...
                if (n && !r.isEmpty(s) && "true" != s.getAttribute("data-dropbox")) {
                    ...
                    r.isEmpty(P) && ((P = document.createElement("div")).className = "popup-close",
                    s.appendChild(P),
                    ...
                    ,
                    (m || y) && (s.hasAttribute("data-resize-scroll") || (s.setAttribute("data-resize-scroll", !0),
                ...
                var A = function() {
                    ...
                    r.isEmpty(v) || s.setAttribute("data-timeout-id-2", v)
                };
                if (t)
                    A();
                else {
                    v = r.runTimeout(function() {
                        "none" == getComputedStyle(s).display ? (c -= 100,
                        A()) : d(!0),
                        s.removeAttribute("data-timeout-id-2")
                    }, 100),
...
LadiPageScriptV2.prototype.runEventTracking = function(t, e, i, a, n) {
    ...
    if (this.runtime.isClient && !this.isEmpty(t)) {
        ...
        e && "form" == s ? (l = r["option.form_conversion_name"],
        d = r["option.form_google_ads_conversion"],
        c = r["option.form_google_ads_label"],
        p = r["option.form_event_custom_script"],
        u = o.isEmpty(r["option.form_purchase_value"]) ? null : parseFloatLadiPage(r["option.form_purchase_value"]) || 0,
        o.runtime.shopping && (u = o.getCartCheckoutPrice(u))) : (l = r["option.conversion_name"],
        d = r["option.google_ads_conversion"],
        c = r["option.google_ads_label"],
        p = r["option.event_custom_script"]);
        var _ = function(t) {
            if (!o.isEmpty(l)) {
                var a = "trackCustom";
                ...
                var n = null
                  , r = null;
                if (o.isEmpty(u) || o.isEmpty(m) || ((n = {}).value = u,
                n.currency = m),
                t)
                    o.runtime.tmp.runActionPopupX({
                        fbq_track_name: a,
                    ...
                    if (window.fbq(a, l, n, r),
                    o.runtime.shopping && e) {
                        var s = o.getCartProducts();
                        o.isNull(s) || (o.isObject(r) || (r = {}),
                        r.cart_products = s)
                    }
                }
                o.isObject(i) && (o.isObject(r) || (r = {}),
                r.email = i.email,
                r.phone = i.phone),
          ...
          , y = function(t) {
            ...
            !o.isEmpty(l)) {
                ...
                o.isEmpty(u) || o.isEmpty(m) || (n.value = u,
                n.currency = m),
                t ? o.runtime.tmp.runActionPopupX({
                    conversion_name: l,
                    gtag_data: n,
        ...
        if (!o.isEmpty(a)) {
            var g = !1;
            return o.isEmpty(d) || o.isEmpty(c) || (g = !0),
            o.isEmpty(l) || (g = !0),
            o.isEmpty(p) || (g = !0),
            void (g && a.addEventListener("click", function(r) {
        ...
        o.isFunction(window.fbq) && _(),
        o.isFunction(window.gtag) && y(),
        o.isEmpty(p) || o.runFunctionString(p)
    }
}
,
...
LadiPageScriptV2.prototype.formatCurrency = function(t, e, i, a) {
    ...
    return i && (o = this.isEmpty(n[e]) ? o + " " + e : n[e].format(o)),
    o
}
,
            ...
            if (3 !== t.nodeType)
                ...
                t.textContent.replace(s, function(e, i) {
                    var n = document.createTextNode(t.textContent.slice(d, i))
                      , o = null;
                    r.isFunction(a) ? o = a(e) : (o = document.createElement("span")).textContent = e,
                    l.appendChild(n),
                    l.appendChild(o),
                    d = i + e.length
                });
...
LadiPageScriptV2.prototype.convertDataReplaceStr = function(t, e, i, a, n, o) {
    ...
    r.runtime.convert_replace_str && (s = r.runtime.replaceNewPrefixStart,
    ...
    for (var d = t = r.isEmpty(t) ? "" : t, c = new RegExp(s + "[^" + s + "$" + l + "]*" + l,"gi"), p = null, u = [], m = function(t) {
        if (a)
            ...
            var i = t
              , c = i.split("|");
            i = c[0].substr(s.length),
            1 == c.length && (i = i.substr(0, i.length - l.length));
            var p = r.getDataReplaceStr(i, n);
            if (r.isEmpty(p))
                if (c.length > 1) {
                    var m = r.randomInt(1, c.length - 1);
                    p = c[m],
                    m == c.length - 1 && (p = p.substr(0, p.length - l.length))
                } else
                    p = "";
            e && (r.isArray(p) && p.length > 1 && (p = JSON.stringify(p)),
            p = encodeURIComponent(p)),
            d = o && r.isArray(p) && p.length > 1 ? p : d.replaceAll(t, p)
        }
    }; null !== (p = c.exec(t)); )
        p.index === c.lastIndex && c.lastIndex++,
        p.forEach(m);
    return u = u.unique(),
...
LadiPageScriptV2.prototype.setDataReplaceElement = function(t, e, i, a, n) {
    ...
    for (var d = o.querySelectorAll("a[data-replace-href]"), c = 0; c < d.length; c++) {
        ...
        p = this.convertDataReplaceStr(p, !0, null, !1, i),
        d[c].href = p
    }
    for (var u = o.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), m = 0; m < u.length; m++) {
        ...
        if (h = this.isEmpty(h) ? h : h.trim(),
        t) {
            var v = u[m].getAttribute("name").trim();
            (g = !0) && -1 == n.indexOf(v) && (g = !1),
            g && "country" == v && "true" == u[m].getAttribute("data-is-select-country") && (g = !1),
            g && (_ = this.getDataReplaceStr(v, i))
        }
        if (!g) {
            if (f = this.findAncestor(u[m], "ladi-element"),
            this.isEmpty(f))
                continue;
            ...
            if (this.isEmpty(P))
                continue;
            var L = !1;
            "INPUT" == u[m].tagName && "checkbox" == h && (L = !0),
            _ = this.convertDataReplaceStr(P, !1, null, !1, i, L)
        }
        if (!this.isNull(_)) {
            if (y = this.isArray(_) ? _[0] : _,
            y = this.isNull(y) ? "" : y,
            y += "",
            "INPUT" == u[m].tagName)
                if ("checkbox" == h || "radio" == h) {
                    ...
                    if ("checkbox" == h) {
                        var b = _;
                        this.isArray(b) || (b = [b]),
                        A = -1 != b.indexOf(u[m].getAttribute("value"))
                    }
                    "radio" == h && (A = u[m].getAttribute("value") == y.trim()),
                    A ? (u[m].checked = !0,
                    e && u[m].setAttribute("checked", "checked")) : (u[m].checked = !1,
                    e && u[m].removeAttribute("checked"));
                    ...
                    f = this.findAncestor(u[m], "ladi-element"),
                    (this.isEmpty(f) || "true" != f.getAttribute("data-quantity")) && (u[m].value = y.trim(),
                    e && u[m].setAttribute("value", u[m].value));
            if ("TEXTAREA" == u[m].tagName && (u[m].value = y.trim(),
            e && (u[m].innerHTML = u[m].value)),
            "SELECT" == u[m].tagName) {
                var T = u[m].querySelector('option[value="' + y.trim() + '"]');
                if (!this.isEmpty(T) && (u[m].value = T.getAttribute("value"),
                e && !T.hasAttribute("selected"))) {
                    for (var O = u[m].querySelectorAll("option"), C = 0; C < O.length; C++)
...
LadiPageScriptV2.prototype.showMessage = function(t, e, i) {
    var a = this;
    if (t = a.convertDataReplaceStr(t, !1, null, !1, e),
    a.runtime.has_popupx)
        ...
        if (this.isEmpty(n) || n.parentElement.removeChild(n),
        this.isEmpty(t))
            return void (this.isFunction(i) && i());
        (n = document.createElement("div")).className = "ladipage-message",
        document.body.appendChild(n);
        var o = document.createElement("div");
        o.className = "ladipage-message-box",
        n.appendChild(o);
        var r = document.createElement("span");
        o.appendChild(r),
        r.textContent = this.const.LANG.ALERT_TITLE;
...
LadiPageScriptV2.prototype.getTextClipboard = function(t, e) {
    var i = this
      , a = function(a) {
        i.isFunction(e) && (a = i.isEmpty(a) ? i.isEmpty(t) ? "" : t : a,
        e(!0, a))
    }
      , n = function() {
        try {
    ...
    var i = this
      ...
      , n = function() {
        try {
            ...
            n.setAttribute("style", "position: fixed; top: 0, left: 0, width: 1px; height: 1px; opacity: 0;"),
            document.body.appendChild(n),
            n.value = t,
            n.select();
            var o = document.execCommand("copy");
            if (n.parentElement.removeChild(n),
            o)
                return void a()
        } catch (t) {}
        i.isFunction(e) && e(!1, null)
...
LadiPageScriptV2.prototype.fireEvent = function(t, e, i) {
    ...
    (a.initEvent(e, !0, !0),
    this.isObject(i)) && Object.keys(i).forEach(function(t) {
        a[t] = i[t]
    });
...
LadiPageScriptV2.prototype.tapEventListener = function(t, e) {
    ...
    "ontouchstart"in window) {
        ...
        t.addEventListener("touchend", function(e) {
            e = i.getEventCursorData(e),
            Math.abs(e.screenX - n) <= s && Math.abs(e.screenY - o) <= s && a(e),
...
LadiPageScriptV2.prototype.getCountdownTime = function(t, e) {
    ...
    l = l < 10 ? "0" + l : l;
    var d = {};
    return d[this.const.COUNTDOWN_ITEM_TYPE.day] = o,
    d[this.const.COUNTDOWN_ITEM_TYPE.hour] = r,
...
LadiPageScriptV2.prototype.showLoadingBlur = function() {
    ...
    this.isEmpty(t) && ((t = document.createElement("div")).className = "ladi-loading",
...
LadiPageScriptV2.prototype.decodeValue = function(t) {
    ...
    if (e.isArray(t))
        for (var i = 0; i < t.length; i++)
            t[i] = e.decodeValue(t[i]);
    return e.isString(t) && (t = t.decode()),
    t
}
,
LadiPageScriptV2.prototype.run = function(t) {
    ...
    if (e.runtime.isLoadHtmlGlobal) {
        ...
        e.isEmpty(e.runtime.timenow) ? (e.runtime.timenow = Date.now(),
        ...
        e.isNull(window.ladi_is_desktop) ? e.runtime.isDesktop = t ? !/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(window.navigator.userAgent.toLowerCase()) : LadiPage.isDesktop() : e.runtime.isDesktop = t ? window.ladi_is_desktop : LadiPage.isDesktop(),
        ...
        u.forEach(function(t) {
            if (t != e.const.TRACKING_NAME && t != e.const.ACCESS_KEY_NAME) {
                if (e.setDataReplaceStr(t, p[t]),
                "products" == t && e.isString(p[t])) {
                    var i = p[t].split("|");
                    2 == i.length && -1 == u.indexOf("product_id") && e.setDataReplaceStr("product_value", i[0]),
                    2 == i.length && -1 == u.indexOf("product_name") && e.setDataReplaceStr("product_name", i[1])
                }
        ...
        e.historyReplaceState(window.location.pathname + m + window.location.hash);
        ...
        var y = Object.keys(e.runtime.eventData)
          ...
          , L = window.ladi("LADI_CAMP_NAME").get_cookie()
          ...
          , C = function(t, i, a) {
            if ("FormSubmit" == t && e.isEmpty(f))
                ...
                e.isEmpty(c.element_id)) ? e.runTimeout(function() {
                    C(t, i, a)
                }, 100) : ("FormSubmit" == t && (e.isEmpty(P) ? v++ : (b == w && v++,
                T++),
                ...
                "PageView" == t && e.runtime.has_popupx && (h++,
                window.ladi("LADI_PAGE_VIEW").set_cookie(h, 3650))
                // ,
                //  e.sendRequest("POST", e.const.API_ANALYTICS_EVENT, JSON.stringify(c)
                // , !0, {
          ...
          , N = function(t, i, a, n) {
            ...
            if (e.isEmpty(i) || "POPUP_PRODUCT" != i.id)
                if (e.isEmpty(i) || "POPUP_BLOG" != i.id)
                    e.isFunction(n) && n();
                else {
                    if (o = e.generateVariantProduct(a, !1, null, null, null, null, !0, !0, function(e) {
                        N(t, i, a, n)
                    }),
                    !e.isObject(o) || !e.isObject(o.product) || !e.isObject(o.store_info))
                        return;
                    var d = function() {
                        var t, a, c = !0;
                        ...
                        c) {
                            ...
                            var m = function(t) {
                                (!e.runtime.isDesktop || e.isEmpty(t.getAttribute("height")) && e.isEmpty(t.style.getPropertyValue("height"))) && (t.addEventListener("load", u),
                                t.addEventListener("error", u))
                            };
                            for (l = 0; l < r.length; l++)
                                e.runtime.tmp.runLadiSaleProductKey(r[l].id, !1, !1, s, o, !0, null, !0),
                                t = r[l],
                                void 0,
                                a = e.runtime.eventData[t.id],
                                e.isFunction(e.runtime.tmp.runOptionAction) && e.isObject(a) && e.runtime.tmp.runOptionAction(t, t.id, a.type, a, o);
                            for (l = 0; l < r.length; l++)
                                for (var _ = r[l].querySelectorAll(".ladi-headline img, .ladi-paragraph img"), y = 0; y < _.length; y++)
                                    m(_[y]);
                            e.isFunction(n) && n(),
                            u(),
                            e.runTimeout(function() {
                ...
                !e.isObject(o) || !e.isObject(o.store_info) || !e.isObject(o.product) || !e.isArray(o.product.variants) || o.product.variants.length <= 0)
                    return;
                if (e.isEmpty(a["option.product_variant_id"])) {
                    ...
                    if (e.isEmpty(c)) {
                        ...
                        p = c.querySelector('[data-variant="true"]');
                    if (!e.isEmpty(p)) {
            ...
            !e.isEmpty(t)) {
                ...
                if (!n["option.action_funnel"] || e.isEmpty(E))
                    if (!l || e.isEmpty(d)) {
                        ...
                        if (!e.isArray(c) && (c = [],
                        e.isObject(n["option.data_action"]))) {
                            var p = e.copy(n["option.data_action"]);
                            p.action_type = e.const.ACTION_TYPE.action,
                            c.push(p)
                        }
                        var u = function(i, a) {
                            ...
                            if (a.action_type == e.const.ACTION_TYPE.action) {
                                if (a.type == e.const.DATA_ACTION_TYPE.link) {
                                    ...
                                    t.addEventListener("click", function(i) {
                                        s(t, i) && "true" == t.getAttribute("data-action") && (r = a.action,
                                        e.isEmpty(a.action_mapping) || (r = a.action_mapping),
                                        e.isEmpty(r) || (r = e.getLinkUTMRedirect(r, null),
                                        r = e.convertDataReplaceStr(r, !0),
                                        window.ladi(r).open_url(a.target, a.nofollow)))
                                    });
                                    var l = function() {
                                        if (e.isNull(o) && (o = e.generateVariantProduct(n, !1, null, null, null, null, !0, !0, l)),
                                        e.isObject(o) && e.isObject(o.store_info) && e.isObject(o.product)) {
                                            r = a.action;
                                            var i = a.link_mapping;
                                            e.isEmpty(i) && (i = a.link_mapping_custom),
                                            e.isEmpty(i) || (a.action_mapping = o.product[i],
                                            e.isEmpty(a.action_mapping) || (r = a.action_mapping)),
                                            e.isEmpty(r) ? (t.removeAttribute("data-replace-href"),
                                ...
                                a.type == e.const.DATA_ACTION_TYPE.copy_clipboard && t.addEventListener("click", function(i) {
                                    if (s(t, i)) {
                                        ...
                                        e.isEmpty(n) || e.copyTextClipboard(n, m)
                                    }
                                });
                                var c = null;
                                if (a.type == e.const.DATA_ACTION_TYPE.lightbox ? c = a.lightbox_type : "lightbox_image" == a.type ? c = e.const.DATA_ACTION_LIGHTBOX_TYPE.image : "lightbox_video" == a.type ? c = e.const.DATA_ACTION_LIGHTBOX_TYPE.video : "lightbox_iframe" == a.type && (c = e.const.DATA_ACTION_LIGHTBOX_TYPE.iframe),
                                c == e.const.DATA_ACTION_LIGHTBOX_TYPE.image && t.addEventListener("click", function(e) {
                        ...
                        t.addEventListener("click", function(i) {
                            if (s(t, i)) {
                                ...
                                e.isEmpty(a) || a.setAttribute("data-button-submit-other", t.id),
                                window.ladi(d).submit()
                            }
                        });
                else
          ...
          , x = function(t, i, a, n) {
            ...
            !e.isEmpty(t)) {
                if (!e.isArray(n)) {
                    var o = e.copy(n);
                    n = [],
                    e.isObject(o) && (o.action_type = e.const.ACTION_TYPE.hover,
                    n.push(o))
                }
          ...
          , R = function(t, i, a, n, o, r, s, l) {
            "countdown" != a || e.isEmpty(n) || (i = i || document.getElementById(t),
            e.isEmpty(i) || (i.setAttribute("data-type", n),
            n != e.const.COUNTDOWN_TYPE.countdown || e.isEmpty(o) || i.setAttribute("data-minute", o),
            n != e.const.COUNTDOWN_TYPE.endtime || e.isEmpty(l) || i.setAttribute("data-endtime", l),
            n != e.const.COUNTDOWN_TYPE.daily || e.isEmpty(r) || e.isEmpty(s) || (i.setAttribute("data-daily-start", r),
            i.setAttribute("data-daily-end", s))))
        }
          , F = function(t, i, a, n) {
            "countdown_item" != a || e.isEmpty(n) || (i = i || document.getElementById(t),
                ...
                C("PageView", {}, function(t, n) {
                    ...
                    200 == t) {
                        var o = JSON.parse(n)
                          , r = !1
                          , s = null;
                        e.isObject(o.data) ? (r = 1 == o.data.verified_domain,
                        s = o.data.google_captcha) : r = 1 == o.data,
                        a || r || e.runTimeout(i, 3e3),
                        e.isObject(s) && function(t, i, a) {
                            if (!e.isEmpty(t)) {
                                var n = !1;
                                ...
                                window.onloadRecaptchaCheckboxCallback = function() {
                                    for (var i = function(e) {
                                        ...
                                        if (!e.isEmpty(r)) {
                                            ...
                                            if (!e.isEmpty(s)) {
                                                if (s["option.is_form_login"] || s["option.is_form_coupon"] || s["option.is_add_to_cart"])
                                                    continue;
                                                if (e.isObject(s["option.form_setting"]) && s["option.form_setting"].is_multiple)
                                                    continue
                                            }
                                        }
                                        i(o)
            ...
            if (e.isEmpty(e.runtime.current_element_mouse_down_gallery_view) && e.isEmpty(e.runtime.current_element_mouse_down_gallery_control)) {
                ...
                if (e.isEmpty(e.runtime.timeout_gallery[o]) && (!e.runtime.tmp.gallery_playing_video || !i)) {
                    ...
                    if (0 != r.length && 0 != r.length) {
                        ...
                        e.runtime.tmp.gallery_playing_video && !r[d].classList.contains("selected") && e.pauseAllVideo(),
                        r[d].classList.add(a);
                        ...
                        e.runtime.timeout_gallery[o] = e.runTimeout(function() {
                            ...
                            e.runtime.timeout_gallery[o] = e.runTimeout(function() {
                                for (var t = 0; t < r.length; t++)
                                    t == d ? r[t].classList.add("selected") : r[t].classList.remove("selected"),
                        ...
                        for (var m = 0; m < s.length; m++)
                            (parseFloatLadiPage(s[m].getAttribute("data-index")) || 0) == d ? s[m].classList.add("selected") : s[m].classList.remove("selected");
                        ...
                        t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                            ...
                            L <= A && t.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                        }
                        ...
                        d <= 0 && t.getElementsByClassName("ladi-gallery-view-arrow-left")[0].classList.add("opacity-0"),
                        d >= c - 1 && t.getElementsByClassName("ladi-gallery-view-arrow-right")[0].classList.add("opacity-0"),
          ...
          , Y = function(t, i, a) {
            ...
            e.isEmpty(l) ? (n == e.const.VIDEO_TYPE.youtube && (l = document.createElement("iframe"),
            i.parentElement.insertBefore(l, i.nextSibling),
            l.outerHTML = '<iframe id="' + s + '" class="iframe-video-preload" data-video-type="' + n + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
            e.runEventPlayVideo(s, n, o, !1, !1, !0, a, !1, !0)),
            n == e.const.VIDEO_TYPE.direct && (l = document.createElement("video"),
            i.parentElement.insertBefore(l, i.nextSibling),
            ...
            e.runEventPlayVideo(s, n, o, !1, !1, !0, a, !1, !0))) : e.runEventReplayVideo(s, n, !0)
        }
          , V = function(t, i, a, n) {
            ...
            !e.isEmpty(i))) {
                ...
                if (o > 0) {
                    for (var l = 0; l < o; l++) {
                        ...
                        e.isEmpty(d) || (s && Y(i, d, s),
                        d.classList.contains("play-video") && d.addEventListener("click", r))
                    }
                    i.setAttribute("data-current", 0),
                    i.setAttribute("data-is-next", !0)
                }
                for (var c = i.getElementsByClassName("ladi-gallery-view-arrow"), p = 0; p < c.length; p++)
                    o <= 1 ? c[p].classList.add("ladi-hidden") : c[p].classList.remove("ladi-hidden")
            }
        }
          , H = function(t, i) {
            t.stopPropagation();
            ...
            var s = parseFloatLadiPage(t.target.getAttribute("data-index")) || 0
              , l = null
              , d = null;
            (parseFloatLadiPage(i.getAttribute("data-current")) || 0) > s ? (l = "prev",
            d = "right") : (l = "next",
            d = "left");
                    ...
                    for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                        ...
                        if ("true" == o.getAttribute("data-scrolled") && "true" != o.getAttribute("data-stop")) {
                            var r = i[e.runtime.device + ".option.gallery_control.autoplay"]
                              ...
                              , l = 0;
                            if (r && !e.isEmpty(s) && (l = s),
                            l > 0) {
                                var d = o.getAttribute("data-next-time")
                                  , c = Date.now();
                                e.isEmpty(d) && (d = c + 1e3 * (l - 1),
                                o.setAttribute("data-next-time", d)),
                                c >= d && (M(o, !0),
          ...
          , U = function(t, i) {
            ...
            if ("gallery" == a.type) {
                ...
                var l = function(t) {
                  ...
                  , d = function(t) {
                    ...
                    !(t = e.getEventCursorData(t)).target.classList.contains("ladi-gallery-view-arrow")) {
                        ...
                        e.isEmpty(e.runtime.timeout_gallery[a]) && (e.runtime.current_element_mouse_down_gallery_view = a,
                ...
                i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].addEventListener("click", function(t) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                            ...
                            r = (r = -(r -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0)) > 0 ? 0 : r,
                            o > 0 && (o = 0),
                            i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", o + "px"),
                            o >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"),
                            o <= r && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                        } else {
                            ...
                            l <= d && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                        }
                        i.setAttribute("data-next-time", Date.now() + 1e3 * s)
                    }
                }),
                ...
                i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].addEventListener("click", function(t) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                            ...
                            var r = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0;
                            o < (r = (r = -(r -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0)) > 0 ? 0 : r) && (o = r),
                            i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", o + "px"),
                            o >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"),
                            o <= r && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                        } else {
                            ...
                            var d = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).height) || 0;
                            l < (d = (d = -(d -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : d) && (l = d),
                            i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", l + "px"),
                            l >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"),
                            l <= d && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                        }
                ...
                i.getElementsByClassName("ladi-gallery-view")[0].addEventListener("mousedown", d),
                i.getElementsByClassName("ladi-gallery-view")[0].addEventListener("touchstart", d, e.runtime.scrollEventPassive),
                ...
                for (var p = i.getElementsByClassName("ladi-gallery-control-item"), u = 0; u < p.length; u++)
          ...
          , j = function(t, i) {
            if ((e.isEmpty(e.runtime.timenext_carousel[t]) || !(e.runtime.timenext_carousel[t] > Date.now())) && e.isEmpty(e.runtime.current_element_mouse_down_carousel)) {
                ...
                if (!e.isEmpty(a)) {
                    ...
                    p < u && (p = u),
                    a.getElementsByClassName("ladi-carousel-content")[0].style.setProperty("left", p + "px"),
          ...
          , W = function() {
            var i, a = document.getElementsByClassName("ladi-form"), n = null, o = null, r = null, s = null, c = null, p = null, u = null, m = null, y = null, g = null, f = null, h = null, v = null, P = null, L = e.runtime.shopping, A = null, w = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"], S = ["name", "email", "phone", "address", "ward", "district", "state", "country"], T = ["email", "phone"], N = e.copy(e.runtime.list_set_value_name_country).reverse(), k = function(t, i) {
                        ...
                        if (!e.isEmpty(d))
                            try {
                                if (!new RegExp("^" + P[s].pattern + "$",P[s].pattern_flag).test(d)) {
                                    i || e.showMessage(P[s].title, null, l),
                                    r = !1;
                                    break
                                }
                            } catch (t) {}
                ...
                o = {},
                r = {};
                for (var a = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), d = {}, c = null, u = 0; u < a.length; u++)
                    c = a[u].getAttribute("name"),
                    d[c] = parseInt(a[u].getAttribute("tabindex")) || 0;
                ...
                for (var f = 0; f < a.length; f++) {
                    ...
                    a[f].required && -1 == v.indexOf(c) && v.push(c);
                    var h = null;
                    ...
                    if (n[c] = a[f].value,
                    a[f].classList.contains("ladi-form-control-file") && (n[c] = JSON.parse(a[f].getAttribute("data-path-file") || "[]"),
                    r[c] = !0),
                    "coupon" == c && "INPUT" == a[f].tagName && "text" == h && "true" == a[f].getAttribute("data-replace-coupon") && (n[c] = e.runtime.tmp.current_use_coupon || ""),
                    "INPUT" == a[f].tagName && "date" == h && !e.isEmpty(n[c])) {
                        var A = a[f].getAttribute("date-format") || "dd-mm-yyyy"
                          , b = new Date(n[c]);
                        A = (A = (A = (A = A.replaceAll("dd", (b.getDate() < 10 ? "0" : "") + b.getDate())).replaceAll("mm", (b.getMonth() + 1 < 10 ? "0" : "") + (b.getMonth() + 1))).replaceAll("yyyy", b.getFullYear())).replaceAll("yy", b.getFullYear() - 2e3),
                        n[c] = A
                    }
                }
                i || S.forEach(function(t) {
                    e.isNull(n[t]) || (window.ladi("_ladipage_" + t).set_cookie(n[t], 365, "/", window.location.host),
                    e.isArray(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function(e) {
                ...
                if (t)
                    o.status_send = 1;
                else if (o.status_send = 2,
                L) {
                    var s = window.ladi("_checkout_token").get_cookie();
                    e.isEmpty(s) || (o.checkout_token = s)
                }
                e.isEmpty(f) || (o.captcha_token = f,
                o.captcha_type = h),
                e.isEmpty(y) || (o.total_revenue = y),
                e.isEmpty(e.runtime.time_zone) || (o.time_zone = e.runtime.time_zone);
                ...
                if (!e.isEmpty(o))
                    for (var r = document.querySelectorAll('.ladi-form [data-submit-form-id="' + o.id + '"]'), s = 0; s < r.length; s++) {
                        ...
                        if (!e.isEmpty(l) && (l = e.findAncestor(l, "ladi-element"),
                        !e.isEmpty(l))) {
                ...
                for (var p = document.querySelectorAll('[data-combobox-type="delivery_method"]'), u = 0; u < p.length; u++)
                    p[u].hasAttribute("data-placeholder") && (p[u].innerHTML = '<option value="">' + p[u].getAttribute("data-placeholder") + "</option>"),
                    p[u].setAttribute("data-selected", "");
                e.runtime.tmp.add_to_cart_shipping_method_id = null
            }, q = function(t, i) {
                D(t, !1),
                x(t, !1, null) && (R(!1, i, function(t) {
                ...
                D(t, a),
                x(t, a, o)) {
                    for (var r = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), l = {}, d = null, u = 0; u < r.length; u++)
                        d = e.findAncestor(r[u], "ladi-element"),
                        l[r[u].getAttribute("name")] = d.id;
                    ...
                    if ((m.mapping_form_id || []).forEach(function(t) {
                        ...
                        if (!e.isEmpty(i)) {
                            if (a) {
                                ...
                                if (e.isEmpty(n) || !n["option.form_auto_capture"])
                                    return
                            }
                            var s = [];
                            if (_.forEach(function(t) {
                                ...
                                for (n = n.unique(),
                                u = 0; u < n.length; u++)
                                    window.ladi(n[u]).value(a)
                            }),
                            a)
                                for (u = 0; u < s.length; u++)
                                    e.fireEvent(s[u], "focusout")
                        }
                    }),
                    !a) {
                        ...
                        if (!e.isArray(y)) {
                            var g = e.copy(m);
                            if (y = [],
                            e.isObject(g) && (g.type = g.event_type,
                            ...
                            !e.isEmpty(g.value))) {
                                ...
                                g.type == e.const.DATA_ACTION_TYPE.section && g.is_hide_parent || g.type == e.const.DATA_ACTION_TYPE.popup) {
                                    var f = e.findAncestor(t, "ladi-popup")
                                      ...
                                      , E = null;
                                    e.isEmpty(f) ? e.isEmpty(h) || (E = h.id) : E = (f = e.findAncestor(f, "ladi-element")).id,
                                    e.isEmpty(E) || y.push({
                                        action_type: e.const.ACTION_TYPE.complete,
                ...
                if (A = e.getURLSearchParams(null, null, !1),
                n = {},
                o = {},
                r = {},
                s = {},
                ...
                g = null,
                f = a.captcha_token,
                e.isObject(e.runtime.tmp.google_captcha) && (h = e.runtime.tmp.google_captcha.type,
                e.isEmpty(f) && a.hasOwnProperty("captcha_token")))
                    B();
                else {
                    v = [],
                    P = [],
                    L = e.findAncestor(i, "ladi-popup"),
                    e.isEmpty(L) ? L = !1 : (L = e.findAncestor(L, "ladi-element"),
                    L = !e.isEmpty(L) && "POPUP_CHECKOUT" == L.id);
                    var b = i.getElementsByClassName("ladi-form")[0];
                    if (!e.isEmpty(b)) {
                        var S = e.runtime.eventData[i.id];
                        if (!e.isEmpty(S)) {
                            if (S["option.is_add_to_cart"])
                                return;
                            u = S["option.form_config_id"],
                            m = i.id,
                            y = parseFloatLadiPage(S["option.form_purchase_value"]) || 0,
                            L && (y = e.getCartCheckoutPrice(y),
                            g = e.getCartProducts())
                        }
                        if (l) {
                            if (e.isEmpty(d))
                            ...
                            return a.captcha && !e.isEmpty(S) && S["option.form_captcha"] && e.isObject(e.runtime.tmp.google_captcha) ? void (window.grecaptcha && (e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise ? window.grecaptcha.enterprise.ready(function() {
                                ...
                                !e.isEmpty(e.runtime.tmp.capture_form_data_last[d + "_" + _]) && e.equals(e.runtime.tmp.capture_form_data_last[d + "_" + _], a) || (e.runtime.tmp.capture_form_data_last[d + "_" + _] = a,
                                e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                                    "Content-Type": "application/json"
                                }))
                            })
                        ...
                        !e.runtime.tmp.form_sending[i.id]) {
                            var T = function() {
                              ...
                              , O = function() {
                                ...
                                b.querySelector(".ladi-button .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]
                            };
                                      ...
                                      , et = function(a, r, l, d) {
                                        if (l.readyState == XMLHttpRequest.DONE) {
                                            if (d == e.const.API_FORM_DATA) {
                                                ...
                                                200 == r || 201 == r ? z++ : e.getElementAHref(d).host == e.const.DOMAIN_GOOGLE_DOCS ? z++ : X++;
                                            z + X == K.length && (Q && !J && z >= 1 ? (J = !0,
                                            o = e.copy(n),
                                            c = e.copy(s),
                                            Object.keys(e.runtime.replaceStr).forEach(function(t) {
                                                o.hasOwnProperty(t) || (o[t] = e.runtime.replaceStr[t]),
                                                c.hasOwnProperty(t) || (c[t] = e.runtime.replaceStr[t])
                                            }),
                                            function(t, i, a) {
                                                var n = null
                                                  , o = !1
                                                  , r = function(t, i) {
                                                    o || (e.isFunction(a) && a(t, i),
                                                    e.removeTimeout(n),
                                                    o = !0)
                                                };
                                                    ...
                                                    e.runTimeout(function() {
                                                        ...
                                                        function() {
                                                            if (H != e.const.FORM_THANKYOU_TYPE.url) {
                                                                ...
                                                                e.isEmpty(a) || (a = e.findAncestor(a, "ladi-element"),
                                                            ...
                                                            if (!W || e.isEmpty(E)) {
                                                                if (H == e.const.FORM_THANKYOU_TYPE.default && (e.isEmpty(G) || e.showMessage(G, c)),
                                                                H == e.const.FORM_THANKYOU_TYPE.popup && (j && e.setDataReplaceElement(!1, !1, c, G),
                                                                window.ladi(G).show()),
                                                                H == e.const.FORM_THANKYOU_TYPE.url && !e.isEmpty(G)) {
                                                                    var s = window.ladi(G).get_url(o, j, !1);
                                                                    e.runTimeout(function() {
                                    ...
                                    e.isArray(V) && V.forEach(function(t) {
                                        if (!e.isEmpty(t.api_url) && e.isArray(t.custom_fields)) {
                                            ...
                                            t.custom_fields.forEach(function(t) {
                                                if (L && ("cart_products" == t.ladi_name && (n = t.name),
                                                "cart_revenue" == t.ladi_name && (o = t.name),
                                                "cart_shipping" == t.ladi_name && (l = t.name),
                                            ...
                                            e.isEmpty(o) || e.isNull(y) || (a[o] = y),
                                            e.isEmpty(l) || e.isNull(e.runtime.tmp.add_to_cart_shipping_method_id) || (a[l] = e.runtime.tmp.add_to_cart_shipping_method_id + "|" + (e.runtime.tmp.add_to_cart_fee_shipping || 0)),
                                            e.isEmpty(d) || e.isEmpty(e.runtime.tmp.current_use_coupon) || (a[d] = e.runtime.tmp.add_to_cart_discount || 0);
                                            var c = {};
                                            ...
                                            if (m == e.const.CONTENT_TYPE.form_urlencoded && (c["Content-Type"] = "application/x-www-form-urlencoded",
                                            u = Object.keys(a).reduce(function(t, e) {
                                                return t.push(e + "=" + encodeURIComponent(a[e])),
                                                t
                                            }, []).join("&")),
                                            m == e.const.CONTENT_TYPE.json && (c["Content-Type"] = "application/json",
                                            u = JSON.stringify(a)),
                ...
                if (!e.isEmpty(i)) {
                    ...
                    if (-1 == o) {
                        ...
                        if (!e.isEmpty(d) && d["option.is_form_login"])
                            !function(t, i) {
                        ...
                        else if (!e.isEmpty(d) && e.isObject(d["option.form_setting"]) && d["option.form_setting"].is_multiple)
                            M(i, d, !1);
                        else {
                            if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.ladisales && !e.isNull(e.runtime.shopping_config_checkout_id)) {
                                ...
                                if (!e.isEmpty(u) && (u = e.findAncestor(u, "ladi-element"),
                                !e.isEmpty(u) && "POPUP_CHECKOUT" == u.id))
                                    return function(t) {
                                        ...
                                        if (e.isEmpty(i) || e.isEmpty(a))
                                            ...
                                            var l = (A = e.getURLSearchParams(null, null, !1)).utm_source
                                              , d = A.utm_medium
                                              , u = A.utm_campaign
                                              , m = A.utm_term
                                              , y = A.utm_content
                                            ...
                                            e.runtime.has_popupx && (C.utm.origin_url_page = e.runtime.tmp.popupx_origin_url),
                                            e.isEmpty(_) || (C.utm[e.const.REF_NAME] = _),
                                            C.custom_fields = {};
                                            var N = Object.keys(n);
                                            ...
                                            e.sendRequest("POST", e.const.API_LADISALE_CHECKOUT_CREATE, JSON.stringify(C), !0, {
                                                ...
                                                if (a.readyState == XMLHttpRequest.DONE) {
                                                    if (200 == i)
                                                        try {
                                                            var n = JSON.parse(t);
                                                            if (200 == n.code && e.isObject(n.data) && !e.isEmpty(n.data.url))
                                                                return void window.ladi(n.data.url).open_url();
                            ...
                            e.isEmpty(d) || !d["option.form_auto_capture"] || e.isEmpty(d["option.form_config_id"]) || (l = k(i.id, d["option.form_config_id"])),
                            Y(i, {
                                captcha: !0
                            }, !1, l)
                        }
                        ...
                        if (m.length > 0) {
                            ...
                            for (var y = 0; y < m.length; y++)
                                m[y].removeEventListener("change", V),
                                m[y].addEventListener("change", V);
                ...
                if (!e.isEmpty(o)) {
                    ...
                    if (!(e.isEmpty(r) || (a = i ? a : e.runtime.eventData[r.id],
                    e.isEmpty(a) || !a["option.is_buy_now"] && !a["option.is_add_to_cart"] || e.isEmpty(a["option.product_type"]) || e.isEmpty(a["option.product_id"])))) {
                        var s = function() {
                            var o = e.generateVariantProduct(a, !1, null, null, null, null, !0, !0, s);
                            if (e.isEmpty(o) || e.isEmpty(o.store_info) || e.isEmpty(o.product))
                                ...
                                if (i) {
                                    ...
                                    d = e.getProductVariantId(c, o.product),
                                    e.isEmpty(d) || (l = o.product.variants.findIndex(function(t) {
                                        return t.product_variant_id == d
                                    }))
                                } else
                                    l = e.getProductVariantIndex(r.id, a);
                                if (-1 != l) {
                                    ...
                                    f = e.isEmpty(f) && e.isObject(o.product.image) ? o.product.image.src : f,
                                    ...
                                    if (0 == o.product.select_many_service && e.isArray(e.runtime.tmp.cart) && -1 != e.runtime.tmp.cart.findIndex(function(t) {
                                        ...
                                        if (e.isEmpty(E) || e.isEmpty(E.value))
                                            ...
                                            var w = !1;
                                            if (!e.isEmpty(b) && e.runtime.tmp.cart[h].quantity + P > b && (P = b - e.runtime.tmp.cart[h].quantity) <= 0 && (w = !0,
                                            L = b),
                                            1 == o.product.variants[l].inventory_checked) {
                                                ...
                                                e.runtime.tmp.cart[h].quantity + P > y && (P = y - e.runtime.tmp.cart[h].quantity,
                                                y > 0 && (w = !0,
                                                (e.isEmpty(L) || L > y) && (L = y)))
                                            }
                                            if (w || P <= 0 && y > 0)
                                                e.showMessage(e.const.LANG.ADD_TO_CART_MAX_QUANTITY, {
                                                    ...
                                                    e.isEmpty(i) || (i = e.findAncestor(i, "ladi-element"));
                                                    var a = e.runtime.eventData[i.id];
                                                    if (!e.isEmpty(a)) {
                                                ...
                                                y <= 0 && e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {
                                                    name: e.getMessageNameProduct(o.product.variants[l], !0)
                                                })
                                        }
                                    }
                ...
                if (!e.isEmpty(i)) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        if (!e.isEmpty(n))
                            if (e.isObject(n["option.form_setting"]) && n["option.form_setting"].is_multiple)
                                M(a, n, !0, t.target.getAttribute("name"));
            ...
            var X = 0
              ...
              , J = function(t) {
                for (var n = a[X].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), o = 0; o < n.length; o++) {
                    var r = z[t];
                    if (!e.isEmpty(r))
                        if ("true" != n[o].getAttribute("data-is-select-country") && (r = i[t]),
                        "SELECT" == n[o].tagName)
                            n[o].querySelectorAll('option[value="' + r + '"]').length > 0 && (n[o].value = r,
                            K && e.fireEvent(n[o], "change"));
                        else {
                            if ("country" == t && "true" == n[o].getAttribute("data-is-select-country"))
                                continue;
                            n[o].value = r,
                            K && e.fireEvent(n[o], "change")
                        }
            ...
            for (X = 0; X < a.length; X++) {
                ...
                for (var $ = e.findAncestor(a[X], "ladi-element"), tt = a[X].getElementsByClassName("ladi-button"), et = 0; et < tt.length; et++) {
                    ...
                    if (!e.isEmpty(it)) {
                        ...
                        e.isEmpty($) || e.isEmpty(e.runtime.eventData[$.id]) || !e.runtime.eventData[$.id]["option.is_add_to_cart"] ? at.addEventListener("click", j) : (at.setAttribute("data-click", !1),
                        at.addEventListener("click", U))
                    }
                }
                ...
                for (var rt = a[X].querySelectorAll('input[data-type="date"]'), st = 0; st < rt.length; st++)
                    e.isEmpty(rt[st].getAttribute("placeholder")) || (rt[st].setAttribute("type", "text"),
                    rt[st].addEventListener("focus", Z),
                    rt[st].addEventListener("blur", Q));
                var lt = a[X].querySelectorAll("[tabindex]")
                  , dt = 0;
                for (st = 0; st < lt.length; st++) {
                    var ct = parseInt(lt[st].getAttribute("tabindex")) || 0;
                    ct > dt && (dt = ct),
                    lt[st].setAttribute("tabindex", e.runtime.tabindexForm + ct)
                }
            ...
            e.runtime.tmp.listAfterLocation.push(function() {
                ...
                for (X = 0; X < a.length; X++) {
                    ...
                    for (m = 0; m < u.length; m++)
                        if (_ = e.findAncestor(u[m], "ladi-element"),
                        !e.isEmpty(_) && (i = e.runtime.eventData[_.id]["option.input_country"],
                        !e.isEmpty(i) && (t = "",
                        i = i.split(":")[0],
                        !e.isEmpty(window.LadiLocation[i])))) {
                            ...
                            r = y,
                            g.sort(s),
                            "VN" == i && (g = g.except(["201", "202", "224", "220", "203"]),
                            g = ["201", "202", "224", "220", "203"].concat(g)),
                            g.forEach(l),
                            u[m].innerHTML = u[m].querySelector("option").outerHTML + t,
                            u[m].setAttribute("data-country", i),
                            u[m].addEventListener("change", d)
                        }
          ...
          , z = function() {
            for (var t = document.querySelectorAll(".ladi-form .ladi-element .ladi-form-control-file"), i = function(t) {
                ...
                if (e.isEmpty(n)) {
                    ...
                    !e.isEmpty(o) && o.classList.contains("accept-all") || n.setAttribute("accept", ".jpg, .jpeg, .png, .gif, .svg, .ico, .mp3, .mp4, .ttf, .otf, .woff2, .txt, .doc, .docx, .xls, .xlsx, .pdf"),
          ...
          , K = function(t) {
            var i = null;
            return e.isEmpty(t) || (i = t.classList.contains("no-value") ? null : t.getAttribute("data-value")),
            i = e.isEmpty(i) ? "" : i
        }
          , J = function(t, i) {
                                ...
                                if (!e.isEmpty(c) && !e.isEmpty(p)) {
                                    ...
                                    if (!(e.isEmpty(u) || e.isEmpty(u.store_info) || e.isEmpty(u.product))) {
                                          ...
                                          , _ = function(t) {
                                            e.updateProductVariantSelectOption(t, r, d, o, function() {
                                                if (o) {
                                                    ...
                                                    if (!e.isArray(a.product.variants))
                                                        return;
                                                    ...
                                                    if (e.isEmpty(s))
                                                        return;
                                                    for (var l = document.querySelectorAll("#POPUP_PRODUCT .ladi-element"), d = 0; d < l.length; d++)
                                                        l[d].id != i && e.runtime.tmp.runLadiSaleProductKey(l[d].id, !1, !0, s, a)
                                                } else
                                        ...
                                        e.showParentVisibility(l, function() {
                                            for (var t = l.clientHeight, i = t, a = l.querySelectorAll("select.ladi-form-control"), n = {}, o = 0; o < a.length; o++)
                                            ...
                                            for (o = 0; o < c.length; o++)
                                                n[c[o].getAttribute("data-store-id") + "_" + c[o].getAttribute("data-product-id") + "_" + c[o].getAttribute("data-product-option-id")] = Z(c[o]);
                                            l.innerHTML = m;
                                            for (var p = null, u = null, g = l.querySelectorAll("select.ladi-form-control"), f = 0; f < g.length; f++)
                                                ...
                                                e.isNull(p) && (u = g[f].querySelector("option"),
                                                e.isEmpty(u) || (p = u.getAttribute("value"))),
                                                g[f].value = p;
                                            var h = l.querySelectorAll(".ladi-form-label-container");
                                            for (f = 0; f < h.length; f++) {
                                                for (var v = h[f].querySelectorAll(".ladi-form-label-item"), E = 0; E < v.length; E++)
                                                    e.tapEventListener(v[E], y);
                                                p = n[h[f].getAttribute("data-store-id") + "_" + h[f].getAttribute("data-product-id") + "_" + h[f].getAttribute("data-product-option-id")],
                                                e.isNull(p) && (u = v[1],
                                                e.isEmpty(u) || (p = K(u))),
                                                J(h[f], p)
                                            }
                                            if (e.updateProductVariantSelectOptionFirst(r, d, l),
                                            d["option.product_variant_type"] != e.const.PRODUCT_VARIANT_TYPE.combined)
                                                l.style.setProperty("height", "auto"),
                                                i = l.clientHeight,
                                                l.style.removeProperty("height"),
                                                i > 0 && t != i && (l.style.setProperty("height", i + "px"),
                                                ...
                                                for (var P = 0; P < g.length; P++) {
                                                    ...
                                                    e.isEmpty(L) || g[P].value == L.getAttribute("value") || (g[P].value = L.getAttribute("value"),
          ...
          , tt = function(i, a, n) {
            if (e.isObject(a) && e.isObject(a.variant) && e.isObject(a.product)) {
                var o = a.variant.src;
                if (e.isEmpty(o) && (o = a.product.image,
                e.isObject(o) && (o = o.src)),
                !e.isEmpty(o)) {
                    ...
                    if (e.isEmpty(r)) {
                        ...
                        for (l = 0; l < c.length; l++)
                            ...
                            e.isEmpty(r) && (d = e.runtime.eventData[c[l].id],
                            e.isEmpty(d) || d["option.product_type"] != n["option.product_type"] || d["option.product_id"] != n["option.product_id"] || s.push(c[l]))
                    } else
                        s = r.querySelectorAll("[data-runtime-id]");
                    for (l = 0; l < s.length; l++)
                        if (d = e.runtime.eventData[s[l].id],
          ...
          , et = function(i, a, n, o, r, s, l, d) {
            ...
            if (!e.isEmpty(c)) {
                ...
                if (s)
                    ...
                    if (e.isEmpty(c) || e.isEmpty(c["option.product_type"]) || e.isEmpty(c["option.product_id"]) || e.isEmpty(p))
                        return;
                    ...
                    !e.isEmpty(l))) {
                        if (c["option.product_id"] != l.target.getAttribute("data-product-id"))
                            return;
                ...
                if ("image" == m) {
                    if (P = document.getElementById(i),
                    e.isEmpty(P))
                        return;
                    A = e.getOptimizeImage(g, P.clientWidth, P.clientHeight, !0, !1, !1, t),
                    L = "style_add_to_cart_image_" + i;
                    var w = "";
                    w = e.isEmpty(A) ? "#" + i + "  > .ladi-image > .ladi-image-background {background-image: none;}" : "#" + i + '  > .ladi-image > .ladi-image-background {background-image: url("' + A + '");}',
                    e.createStyleElement(L, w)
                }
                if ("gallery" == m) {
                    if (!e.isArray(g))
                        return;
                    ...
                    for (var C = P.getElementsByClassName("ladi-gallery-control-item"), N = function(t) {
                        ...
                        P.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(I)
                    }
                    for (; C.length > g.length; )
                        C[C.length - 1].parentElement.removeChild(C[C.length - 1]);
                    L = "style_add_to_cart_gallery_" + i;
                    var k = "";
                    g.length <= 1 && (k += "#" + i + " .ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow {display: none;}",
                    ...
                    g.forEach(function(a, n) {
                        A = e.getOptimizeImage(a.src, S.clientWidth, S.clientHeight, !0, !1, !1, t),
                        k += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + A + '");}',
                        A = e.getOptimizeImage(a.src, x.clientWidth, x.clientHeight, !0, !1, !1, t),
                        k += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + A + '");}'
                    }),
                    P.setAttribute("data-max-item", g.length),
                    P.setAttribute("data-loaded", !0),
                    e.createStyleElement(L, k)
                }
            }
        }
          , it = function(t) {
          ...
          , dt = function() {
            ...
            y.forEach(function(i) {
                ...
                e.isEmpty(r) ? (!function(t, i, a, n, o, r) {
                    ...
                    if (!e.isEmpty(s) && (D(t),
                    "section" == i && !e.isEmpty(o) && !e.isEmpty(r))) {
                        ...
                        e.isEmpty(l) || (e.runtime.list_scroll_func[t] = function() {
                            if ((!e.runtime.isDesktop || a == e.const.BACKGROUND_STYLE.video) && (e.runtime.isDesktop || n == e.const.BACKGROUND_STYLE.video)) {
                                ...
                                o == e.const.VIDEO_TYPE.youtube && (i = '<iframe id="' + s + '" class="ladi-section-background-video" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>',
                                l.innerHTML += i,
                                e.runEventPlayVideo(s, o, r, !0, !0, !1)),
                                o == e.const.VIDEO_TYPE.direct && (i = '<video id="' + s + '" class="ladi-section-background-video" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;"></video>',
                                l.innerHTML += i,
                                e.runEventPlayVideo(s, o, r, !0, !0, !1))
                            }
                        }
                ...
                }(i, o.type, o[e.const.DESKTOP + ".option.background-style"], o[e.const.MOBILE + ".option.background-style"], o["option.background_video.video_type"], o["option.background_video.video_value"]),
                k(null, i, o.type, o),
                a = o.type,
                n = o["option.data_event"] || o["option.data_action"],
                e.runtime.list_loaded_func.push(function() {
                    var t = 0;
                    if (-1 != ["headline", "paragraph", "list_paragraph"].indexOf(a) && (t = 1e3),
                    !e.isArray(n)) {
                        var i = e.copy(n);
                        n = [],
                        e.isObject(i) && (i.action_type = e.const.ACTION_TYPE.action,
                        n.push(i))
                    }
                    e.runTimeout(function() {
                        n.forEach(function(t) {
                ...
                x(null, i, o.type, o["option.data_event"] || o["option.data_hover"]),
                function(t, i, a, n, o, r, s) {
                    if ("video" == i && !e.isEmpty(a)) {
                        ...
                        if (!e.isEmpty(l)) {
                            var d = function() {
                                var i = e.runtime.eventData[t];
                                e.isEmpty(i) || (n = i["option.video_type"],
                            ...
                            if (c) {
                                ...
                                e.isEmpty(u) ? e.runtime.list_scroll_func[t] = p : (u = e.findAncestor(u, "ladi-element"),
                                e.isArray(e.runtime.list_show_popup_func[u.id]) || (e.runtime.list_show_popup_func[u.id] = []),
                ...
                }(i, o.type, o["option.video_value"], o["option.video_type"], o["option.video_control"], o[e.const.DESKTOP + ".option.video_autoplay"], o[e.const.MOBILE + ".option.video_autoplay"]),
                function(t, i, a, n) {
                    "popup" == i && a && ((e.isEmpty(n) || n < 0) && (n = 0),
                    e.runTimeout(function() {
                        window.ladi(t).show()
                    }, 1e3 * n))
                }(i, o.type, o["option.show_popup_welcome_page"], o["option.delay_popup_welcome_page"]),
                R(i, null, o.type, o["option.countdown_type"], o["option.countdown_minute"], o["option.countdown_daily_start"], o["option.countdown_daily_end"], o["option.countdown_endtime"]),
                F(i, null, o.type, o["option.countdown_item_type"]),
                function(t, i, a, n) {
                    if ("section" == i) {
                ...
                }(i, o.type, o[e.const.DESKTOP + ".option.readmore_range"], o[e.const.MOBILE + ".option.readmore_range"]),
                function(t, i, a) {
                    if ("form_item" == i) {
                        var n = null
                          , o = null;
                        ...
                        !e.isEmpty(n)))
                            for (var r = n.getElementsByClassName("ladi-form-control"), s = 0; s < r.length; s++)
                        ...
                        if (a == e.const.INPUT_TYPE.checkbox) {
                            ...
                            if (!e.isEmpty(n)) {
                                ...
                                for (var c = 0; c < o.length; c++) {
                                    ...
                                    o[c].getElementsByTagName("span")[0].addEventListener("click", d),
                ...
                }(i, o.type, o["option.input_type"]),
                V(i, null, !1, o.type),
                e.startAutoScroll(i, o.type, o[e.const.DESKTOP + ".option.auto_scroll"], o[e.const.MOBILE + ".option.auto_scroll"]),
                $(i, o.type, !0, !1),
                function(t, i) {
                    if ("form" == i) {
                        var a = document.getElementById(t);
                                        ...
                                        if (!e.isEmpty(a) && a["option.is_add_to_cart"]) {
                                            ...
                                            if (!(e.isEmpty(n) || e.isEmpty(n.store_info) || e.isEmpty(n.product))) {
                                                ...
                                                if (-1 != r) {
                                                    ...
                                                    c > d + u && (d = c - u),
                                                    1 == n.product.variants[r].inventory_checked && d + u > s && (d = s - u),
                                                    !e.isEmpty(p) && d + u > p && (d = p - u),
                                                    d = d < 1 ? 1 : d,
                    ...
                    if ("collection" == i) {
                        ...
                        if (!e.isEmpty(a)) {
                            ...
                            if (!e.isEmpty(n)) {
                                ...
                                if (o == e.const.COLLECTION_TYPE.carousel && r.classList.add("carousel"),
                    ...
                    if ("survey" == i) {
                        ...
                        if (!e.isEmpty(o)) {
                            ...
                            if (!e.isArray(p)) {
                                var u = e.copy(n);
                                if (p = [],
                                e.isObject(u) && !e.isEmpty(u.value)) {
                            ...
                            for (var g = function() {
                                ...
                                c.forEach(function(t) {
                                    ...
                                    if (!e.isEmpty(o)) {
                                        ...
                                        for (P = 0; P < d.length; P++) {
                                            d[P].getAttribute("name") == n && (c = e.findAncestor(d[P], "ladi-element"),
                                            s.push(c.id));
                                        ...
                                        if (0 == (s = s.unique()).length) {
                                            p++,
                                            (c = document.createElement("div")).className = "ladi-element ladi-hidden ladi-form-item-survey",
                                            ...
                                            a) {
                                                ...
                                                for (var _ = 0; _ < l.length; _++)
                                                    m += '   <div class="ladi-form-checkbox-item"><input tabindex="' + p + '" name="' + n + '" type="checkbox" value="' + l[_] + '"><span data-checked="false">' + l[_] + "</span></div>";
                                                m += "   </div>"
                                            } else
                                            ...
                                            m += "</div>",
                                            c.innerHTML = m,
                                            o.getElementsByClassName("ladi-form")[0].appendChild(c),
                                            s.push(c.id)
                                        }
                                        for (P = 0; P < s.length; P++)
                                            window.ladi(s[P]).value(i)
                                    }
                                })
                            }, f = function() {
                                ...
                                e.tapEventListener(t, function(i) {
                                    ...
                                    a)
                                        ...
                                        for (var n = t.parentElement.getElementsByClassName("ladi-survey-option"), o = 0; o < n.length; o++)
                                            n[o] === t ? n[o].classList.add("selected") : n[o].classList.remove("selected");
                                    E(),
                                    e.isEmpty(s) && h()
                                })
                            }, E = function() {
                                ...
                                l.push(r[P].getAttribute("data-value")),
                                v(r[P]);
                    ...
                    if ("countdown" == e.runtime.eventData[t].type)
                        for (var i = document.querySelectorAll("#" + t), a = 0; a < i.length; a++) {
                            var n = i[a]
                              ...
                              , s = 0
                              , l = Date.now();
                            if (n.hasAttribute("data-date-start") || n.hasAttribute("data-date-end"))
                                r = parseFloatLadiPage(n.getAttribute("data-date-start")) || 0,
                                s = parseFloatLadiPage(n.getAttribute("data-date-end")) || 0;
                            else {
                                ...
                                if (o == e.const.COUNTDOWN_TYPE.endtime && (s = parseInt(n.getAttribute("data-endtime")) || 0),
                                o == e.const.COUNTDOWN_TYPE.daily) {
                                    var c = n.getAttribute("data-daily-start")
                                      , p = n.getAttribute("data-daily-end");
                                    if (!e.isEmpty(c) && !e.isEmpty(p)) {
                                        var u = (new Date).toDateString();
                                        r = new Date(u + " " + c).getTime(),
                                        s = new Date(u + " " + p).getTime()
                                    }
                                }
                                n.setAttribute("data-date-start", r),
                ...
                if ("carousel" == i.type) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        var s = function(i) {
                            ...
                            !e.isEmpty(e.runtime.timenext_carousel[t]) && e.runtime.timenext_carousel[t] > Date.now() || i.target.classList.contains("ladi-carousel-arrow") || (e.runtime.timenext_carousel[t] = Date.now() + 864e5,
                    ...
                    if ("carousel" == i.type) {
                        ...
                        if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                            var n = i[e.runtime.device + ".option.carousel_setting.autoplay"]
                              , o = i[e.runtime.device + ".option.carousel_setting.autoplay_time"]
                              , r = 0;
                            if (n && !e.isEmpty(o) && (r = o),
                            r > 0) {
                                var s = a.getAttribute("data-next-time")
                                  , l = Date.now();
                                e.isEmpty(s) && (s = l + 1e3 * (r - 1),
            ...
            function() {
                                ...
                                if (!e.isEmpty(p)) {
                                    ...
                                    if (e.isEmpty(u) || e.isEmpty(u["option.data_submit_form_id"])) {
                                        if (!p["option.is_form_login"] && !p["option.is_form_coupon"]) {
                                            ...
                                            e.isEmpty(m) || (m = e.findAncestor(m, "ladi-element")),
                                            e.isEmpty(m) || "POPUP_CHECKOUT" != m.id || e.runtime.tmp.list_form_checkout.push(c.id)
                                        }
                                    } else if (p["option.is_form_coupon"]) {
                                        l.setAttribute("data-submit-form-id", u["option.data_submit_form_id"]),
                ...
                for (var g = function(t) {
                    ...
                    for (var h = document.querySelectorAll("#" + e.runtime.tmp.list_form_checkout[f] + " .ladi-form-item input.ladi-form-control"), v = 0; v < h.length; v++)
                        -1 != t.indexOf(h[v].getAttribute("name")) && (h[v].addEventListener("change", g),
                        h[v].addEventListener("input", g))
            }(),
            q(),
            ...
            y.forEach(function(t) {
                ...
                if (!e.isEmpty(i)) {
                    ...
                    if (!e.isEmpty(n)) {
                        ...
                        var l = "hint";
                        r == e.const.TOOLTIP_POSITION.top_middle && (l += "-top-middle"),
                        r == e.const.TOOLTIP_POSITION.top_left && (l += "-top-left"),
                        r == e.const.TOOLTIP_POSITION.top_right && (l += "-top-right"),
                        r == e.const.TOOLTIP_POSITION.bottom_middle && (l += "-bottom-middle"),
                        r == e.const.TOOLTIP_POSITION.bottom_left && (l += "-bottom-left"),
                        r == e.const.TOOLTIP_POSITION.bottom_right && (l += "-bottom-right"),
                        r == e.const.TOOLTIP_POSITION.left_middle && (l += "-left-middle"),
                        r == e.const.TOOLTIP_POSITION.left_top && (l += "-left-top"),
                        r == e.const.TOOLTIP_POSITION.left_bottom && (l += "-left-bottom"),
                        r == e.const.TOOLTIP_POSITION.right_middle && (l += "-right-middle"),
                        r == e.const.TOOLTIP_POSITION.right_top && (l += "-right-top"),
                        r == e.const.TOOLTIP_POSITION.right_bottom && (l += "-right-bottom"),
                    ...
                    u) {
                        ...
                        if (!e.isEmpty(m)) {
                            ...
                            if (0 != _.length) {
                                var y = !1
                                  ...
                                  , f = function(i, a, n, o) {
                                    if (!y) {
                                        ...
                                        e.isEmpty(r) && document.querySelectorAll("html")[0].classList.contains("no-csstransitions")) {
                                            var s = v(a);
                                            E(a, s)
                                        }
                                    }
                                  ...
                                  , h = function(i, a, n, o) {
                                    if (!y) {
                                        var r = a.parentElement
                                          , s = r.parentElement;
                                        s.classList.contains("ladipage-animated-headline") || (s = s.parentElement),
                                        e.isEmpty(i) || (i.classList.add("in"),
                                        i.classList.remove("out"));
                                        var l = e.isEmpty(i) ? null : i.nextSibling;
                                        e.isEmpty(l) ? ((s.classList.contains("rotate-2") || s.classList.contains("rotate-3") || s.classList.contains("scale")) && r.style.setProperty("width", a.clientWidth + "px"),
                                        e.isEmpty(e.findAncestor(a, "type")) || e.runTimeout(function() {
                                  ...
                                  , E = function(t, e) {
                                    y || (t.classList.remove("is-visible"),
                                    t.classList.add("is-hidden"),
                                    e.classList.remove("is-hidden"),
                                    e.classList.add("is-visible"))
                                }
                                  , P = function(t, i) {
                                    y || (e.isEmpty(e.findAncestor(t, "type")) ? e.isEmpty(e.findAncestor(t, "clip")) || (e.findAncestor(t, "ladipage-animated-words-wrapper").style.setProperty("width", t.clientWidth + 5 + "px"),
                                    e.runTimeout(function() {
                                        L(t)
                                    }, l + d)) : (h(t.querySelectorAll("i")[0], t, !1, i),
                                    ...
                                    if (!y && !e.isEmpty(d)) {
                                        ...
                                        if (e.isEmpty(e.findAncestor(d, "type")))
                                            if (e.isEmpty(e.findAncestor(d, "letters")))
                                                e.isEmpty(e.findAncestor(d, "clip")) ? e.isEmpty(e.findAncestor(d, "loading-bar")) ? (E(d, c),
                                                e.runTimeout(function() {
                                                    L(c)
                                                }, t)) : (e.findAncestor(d, "ladipage-animated-words-wrapper").classList.remove("is-loading"),
                                                E(d, c),
                                                e.runTimeout(function() {
                                                    L(c)
                                                }, i),
                                                ...
                                                }, a)) : (e.findAncestor(d, "ladipage-animated-words-wrapper").style.setProperty("width", "2px"),
                                                e.runTimeout(function() {
                                                    E(d, c),
                                                    P(c)
                                                }, l));
                                                ...
                                                f(d.querySelectorAll("i")[0], d, p, n),
                                                h(c.querySelectorAll("i")[0], c, p, n)
                                            }
                                        else {
                                            ...
                                            e.runTimeout(function() {
                                                ...
                                                for (var t = d.querySelectorAll("i"), e = 0; e < t.length; e++)
                                ...
                                A.outerHTML = p.outerHTML,
                                (A = p.nextSibling).classList.add("ladipage-animated-headline-duplicate"),
                                e.runtime.list_scrolling_exec[g] = function() {
                                    p.parentElement.removeChild(p),
                                    A.classList.remove("ladipage-animated-headline-duplicate"),
                                    y = !0,
                                    delete e.runtime.list_scrolling_exec[g]
                                }
                                ;
                                ...
                                !e.isEmpty(e.findAncestor(m, "type")) || !e.isEmpty(e.findAncestor(m, "loading-bar")) || !e.isEmpty(e.findAncestor(m, "clip"))) {
                                    ...
                                    for (var w = getComputedStyle(m).color, S = m.getElementsByClassName("after"), T = 0; T < S.length; T++)
                                        S[T].style.setProperty("background-color", w)
                                }
                                if (p.classList.contains("type") && m.classList.add("waiting"),
                                                        ...
                                                        if (!e.isEmpty(y)) {
                                                            ...
                                                            if (!e.isEmpty(g)) {
                                                                ...
                                                                if (!e.isEmpty(f)) {
                                                                    ...
                                                                    if (!e.isEmpty(h) && !e.isEmpty(h["option.product_variant_id"]))
                                                                        continue
                                                                }
                                                                var v = null
                                                                  , E = null
                                                                ...
                                                                if (y["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combobox) {
                                                                    ...
                                                                    e.isString(E.option_ids))
                                                                        ...
                                                                        L = 0; L < P.length; L++)
                                                                            ...
                                                                            e.isEmpty(v) || v.getAttribute("data-store-id") != p.store_info.id || v.getAttribute("data-product-id") != E.product_id || (v.value = E["option" + (L + 1)])
                                                                }
                                                                if (y["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.label) {
                                                                    ...
                                                                    e.isString(E.option_ids))
                                                                        ...
                                                                        L = 0; L < P.length; L++)
                                                                            ...
                                                                            e.isEmpty(v) || v.getAttribute("data-store-id") != p.store_info.id || v.getAttribute("data-product-id") != E.product_id || e.runtime.tmp.updateLabelValue(v, E["option" + (L + 1)])
                                                                }
                        ...
                        if (!e.isEmpty(n)) {
                            ...
                            e.isEmpty(o) || e.showParentVisibility(o, function() {
                                ...
                                if (i != (s = s < a ? a : s)) {
                                    ...
                                    e.isEmpty(l) && (l = e.findAncestor(o.parentElement, "ladi-section")),
                ...
                i.iframe_id == e.runtime.tmp.popupx_iframe_id && i.action.value.forEach(function(t) {
                    !function(t, i) {
                        ...
                        if ("set_iframe_info" == t) {
                            e.isEmpty(f) && (f = i.ladi_client_id || e.randomId(),
                        ...
                        "show_popupx_inline_iframe" == t && st(i, !0),
                        "show_message_callback" == t && (e.isFunction(e.runtime.tmp.popupx_show_message_callback) && e.runtime.tmp.popupx_show_message_callback(),
...
LadiPageScriptV2.prototype.getListProductByTagId = function(t, e, i, a, n) {
    ...
    if (o.isArray(d) && d.length > 0) {
        if (o.isEmpty(o.runtime.tmp.product_tag_info[s]) && (o.runtime.tmp.product_tag_info[s] = {}),
        o.isEmpty(o.runtime.tmp.timeout_product_tag_info[s]) && (o.runtime.tmp.timeout_product_tag_info[s] = {}),
        d.sort(),
        f = JSON.stringify(d) + "_page_" + i + "_limit_" + e,
        h = o.runtime.tmp.product_tag_info[s][f],
        -1 != [o.const.FORM_CONFIG_TYPE.ladisales, o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify, o.const.FORM_CONFIG_TYPE.wordpress].indexOf(s)) {
            g = function() {
                var t = null;
                ...
                o.isEmpty(o.runtime.tmp.product_info[s]) && (o.runtime.tmp.product_info[s] = {}),
            ...
            o.isNull(h)) {
                ...
                var P = function() {
                    ...
                    o.isEmpty(o.runtime.tmp.timeout_product_tag_info[s][f]) || (o.removeTimeout(o.runtime.tmp.timeout_product_tag_info[s][f]),
                  ...
                  , L = function(t) {
                    ...
                    o.isObject(h)) {
                        if (!o.isObject(h.store_info)) {
                            ...
                            o.runtime.isClient || (a = LadiPage.getRootScope().getStoreCurrency()),
                            h.store_info = {
                                currency: {
                                    code: a,
                        ...
                        if (s != o.const.FORM_CONFIG_TYPE.ladisales && (h.store_info.id = -1),
                        o.isArray(h.products))
                            for (var r = null, l = function(t) {
                                ...
                                if (o.isArray(h.products[c].options) && o.isArray(h.products[c].variants)) {
                                    ...
                                    p = p.join("/");
                                    for (var u = 0; u < h.products[c].variants.length; u++)
                                        -1 != [o.const.FORM_CONFIG_TYPE.ladisales].indexOf(s) && 1 == h.products[c].variants[u].allow_sold_out && (h.products[c].variants[u].inventory_checked = 0),
                                        o.isNull(h.products[c].variants[u].compare_price) && (h.products[c].variants[u].compare_price = h.products[c].variants[u].price_compare),
                                        o.isNull(h.products[c].variants[u].variant_start_date) && (h.products[c].variants[u].variant_start_date = h.products[c].variants[u].start_date),
                                        o.isNull(h.products[c].variants[u].variant_end_date) && (h.products[c].variants[u].variant_end_date = h.products[c].variants[u].end_date),
                                        o.isNull(h.products[c].variants[u].variant_timezone) && (h.products[c].variants[u].variant_timezone = h.products[c].variants[u].timezone),
                                        o.isEmpty(h.products[c].variants[u].option_ids) && (h.products[c].variants[u].option_ids = p),
                                        -1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(s) && 1 == h.products[c].variants.length && "Default Title" == h.products[c].variants[u].title && (h.products[c].variants[u].title = null,
                                        h.products[c].variants[u].option1 = null,
                                        h.products[c].options = []),
                                        -1 != [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(s) && 1 == h.products[c].variants.length && h.products[c].variants[u].title == h.products[c].variants[u].product_name && (h.products[c].variants[u].title = null,
                                        h.products[c].variants[u].option1 = null,
                                        h.products[c].options = []),
                                        o.isEmpty(h.products[c].variants[u].package_quantity) || o.isEmpty(h.products[c].variants[u].package_quantity_unit) || (o.isNull(h.products[c].variants[u].title_old) && (h.products[c].variants[u].title_old = h.products[c].variants[u].title),
                                        h.products[c].variants[u].title = h.products[c].variants[u].title_old + " (" + h.products[c].variants[u].package_quantity + " " + h.products[c].variants[u].package_quantity_unit + ")");
                                    if (o.isArray(h.products[c].options) && 1 == h.products[c].options.length && o.isArray(h.products[c].options[0].values))
                                        for (var m = 0; m < h.products[c].options[0].values.length; m++) {
                                            ...
                                            h.products[c].options[0].values[m].name_new = h.products[c].options[0].values[m].label || h.products[c].options[0].values[m].name,
                                            o.isEmpty(_) || o.isEmpty(_.package_quantity) || o.isEmpty(_.package_quantity_unit) || (h.products[c].options[0].values[m].name_new = h.products[c].options[0].values[m].name_new + " (" + _.package_quantity + " " + _.package_quantity_unit + ")")
                                        }
                                }
                        ...
                        o.runtime.tmp.product_tag_info[s][f] = h,
                        y = g(),
                        o.isFunction(n) && n(y)
                    } else
                        P()
                ...
                o.isEmpty(u) ? A.type = "group" : A.paged = i,
                o.isEmpty(m) || o.isEmpty(_) || (A.sort = {},
                A.sort[m] = _ == o.const.SORT_BY_TYPE.desc ? -1 : 1);
                var b = null
                  , w = "POST";
                return o.runLimitRequest(20, function() {
                    if (o.runtime.isClient) {
                        ...
                        A = JSON.stringify(A)) : s == o.const.FORM_CONFIG_TYPE.wordpress ? (w = "GET",
                        a = window.location.origin + "/ladipage/api?action=product_list&category_ids=" + d.join("|") + "&page=" + i + "&limit=" + e,
                        A = null) : (b = {
                            "Content-Type": "application/json"
                        },
                        ...
                        o.isEmpty(E) ? A.page = i : A.page_info = E,
                        A = JSON.stringify(A)),
                        ...
                        var n = function(t) {
                            if (o.isArray(t) && t.length > 1) {
                                ...
                                t.forEach(function(t) {
                                    if (o.isNull(t.product) && !o.isNull(t.store_info) && !o.isNull(t.total_record))
      ...
      , e = function() {
        ...
        return t.runtime.tmp.cart.forEach(function(i) {
            if (!(i.quantity <= 0)) {
                ...
                t.isObject(i.promotion) && n.push([i.promotion.discount.discount_id, i.promotion.discount.note, i.promotion.total].join(":")),
                n = n.join("|"),
                e.push(n)
            }
        }),
...
LadiPageScriptV2.prototype.createCartData = function(t) {
    ...
    if (e.isEmpty(e.runtime.shopping_product_type) || window.ladi("_shopping_product_type").get_cookie() != e.runtime.shopping_product_type && (window.ladi("_cart_token").delete_cookie(),
    window.ladi("_checkout_token").delete_cookie(),
                            ...
                            try {
                                ...
                                o.data.items.forEach(function(t) {
                                    ...
                                    var a = e.runtime.tmp.cart.findIndex(function(e) {
                                      ...
                                      , r = t.option_name
                                      , s = t.price;
                                    e.isEmpty(t.package_quantity) || e.isEmpty(t.package_quantity_unit) || (r = r + " (" + t.package_quantity + " " + t.package_quantity_unit + ")"),
                                    -1 == a && e.runtime.tmp.cart.push({
                                        store_id: t.store_id,
...
LadiPageScriptV2.prototype.changeTotalPriceCart = function(t) {
    ...
    this.runtime.tmp.cart.forEach(function(t) {
        a += t.quantity,
        e.isObject(t.promotion) ? i += t.promotion.total : i += t.price * t.quantity
    }),
    i = i < 0 ? 0 : i;
    ...
    if (this.runtime.tmp.cart.length > 0 && !this.isEmpty(this.runtime.tmp.cart[0].currency) && !this.isEmpty(this.runtime.tmp.cart[0].currency.symbol)) {
        ...
        d = this.formatCurrency(n, p, !0),
        c = this.formatCurrency(o, p, !0)
    }
...
LadiPageScriptV2.prototype.removeAddToCartProduct = function(t, e, i, a) {
    ...
    -1 != s && this.updateCartCookie({
        ...
        -1 != (s = n.runtime.tmp.cart.findIndex(r)) && n.runtime.tmp.cart.splice(s, 1),
...
LadiPageScriptV2.prototype.changeAddToCartProductQuantity = function(t, e, i) {
    ...
    if (-1 != r) {
        ...
        a.isEmpty(u) || (d = u.min_buy || d,
        c = u.max_buy);
        var m = this.runtime.tmp.cart[r].quantity;
        if (this.isEmpty(t.value))
            i && (t.value = d),
            this.runtime.tmp.cart[r].quantity = d;
        else {
            var _ = parseInt(t.value) || 0;
            1 == this.runtime.tmp.cart[r].inventory_checked && _ > (l = this.runtime.tmp.cart[r].available_quantity) && (_ = l,
            s = !0,
            p = l),
            _ = _ < d ? d : _,
            !this.isEmpty(c) && _ > c && (_ = c,
            s = !0,
            (a.isEmpty(p) || p > c) && (p = c)),
        ...
        this.updateCartCookie(g, !1, function() {
            var t = document.getElementsByClassName("ladi-form-remove-coupon")[0];
            a.isEmpty(t) || t.click(),
            a.updateCartPromotion()
        }, function(t) {
            a.runtime.tmp.cart[r].quantity -= y - m,
                ...
                for (var n = document.querySelectorAll(".ladi-cart-price span[data-product-variant-id]"), s = 0; s < n.length; s++)
                    if (n[s].getAttribute("data-store-id") == a.runtime.tmp.cart[r].store_id && n[s].getAttribute("data-product-id") == a.runtime.tmp.cart[r].product_id) {
                        if (a.isEmpty(a.runtime.tmp.cart[r].cart_item_key)) {
                            if (n[s].getAttribute("data-product-variant-id") != a.runtime.tmp.cart[r].product_variant_id)
                                continue
                        } else if (n[s].getAttribute("data-cart-item-key") != a.runtime.tmp.cart[r].cart_item_key)
                            continue;
                        n[s].innerHTML = i;
                        ...
                        if (!a.isEmpty(l)) {
                            ...
                            if (!a.isEmpty(d) && !a.isEmpty(c) && d.id == c.id)
                                continue;
    ...
    if (o.isObject(s)) {
        ...
        if (o.isEmpty(d))
            for (var u = document.querySelectorAll('[data-variant="true"]'), m = 0; m < u.length; m++) {
                ...
                if (!o.isEmpty(_) && (_ = o.findAncestor(_, "ladi-element"),
                o.isEmpty(o.findAncestor(_, "ladi-collection")))) {
            ...
            c = d.querySelectorAll('[data-variant="true"]');
        var g = [];
        ...
        if (o.isArray(s.product.variants) && 0 != s.product.variants.length) {
            if (o.isString(s.product.variants[0].option_ids)) {
                for (P = s.product.variants[0].option_ids.split("/"),
                p = 0; p < P.length; p++)
                    if (P[p] == h) {
                        E = p;
                        break
                    ...
                    s.product.variants.forEach(function(t) {
                        if (o.isEmpty(L) || L == t["option" + (E + 1)])
                            for (p = 0; p < P.length; p++)
                                o.isArray(v[P[p]]) || (v[P[p]] = []),
                                p != E && v[P[p]].push(t["option" + (p + 1)])
                    })
                }
            }
            for (var A = v, b = [], w = [], S = null, T = 0; T < g.length; T++) {
                ...
                if (!o.isEmpty(O)) {
                    ...
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox) {
                        if (S = g[T].querySelectorAll("select[data-product-option-id]"),
                        o.isObject(v)) {
                            for (C = 0; C < S.length; C++)
                                if ((x = S[C].getAttribute("data-product-option-id")) != h)
                                    for (o.isArray(v[x]) && -1 != v[x].indexOf(S[C].value) || (S[C].value = ""),
                                    D = S[C].getElementsByTagName("option"),
                                    N = 0; N < D.length; N++)
                                        o.isEmpty(D[N].getAttribute("value")) || D[N].removeAttribute("disabled");
                            for (C = 0; C < S.length; C++) {
                                for (x = S[C].getAttribute("data-product-option-id"),
                                v = {},
                                I = 0; I < s.product.variants.length; I++)
                                    if (F = s.product.variants[I],
                                    P = F.option_ids.split("/"),
                                    -1 != (E = P.indexOf(x)) && (o.isEmpty(S[C].value) || S[C].value == F["option" + (E + 1)]))
                                        for (p = 0; p < P.length; p++)
                                            o.isArray(v[P[p]]) || (v[P[p]] = []),
                                            p != E && v[P[p]].push(F["option" + (p + 1)]);
                                for (k = 0; k < S.length; k++)
                                    if ((R = S[k].getAttribute("data-product-option-id")) != x)
                                        for (D = S[k].getElementsByTagName("option"),
                                        N = 0; N < D.length; N++)
                                            o.isEmpty(D[N].getAttribute("value")) || o.isArray(v[R]) && -1 != v[R].indexOf(D[N].getAttribute("value")) || D[N].setAttribute("disabled", "")
                            }
                        }
                        if (!o.isObject(v))
                            for (C = 0; C < S.length; C++)
                    ...
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label) {
                        if (S = g[T].querySelectorAll(".ladi-form-label-container[data-product-option-id]"),
                        o.isObject(v)) {
                            for (C = 0; C < S.length; C++)
                                if ((x = S[C].getAttribute("data-product-option-id")) != h) {
                                    var q = o.runtime.tmp.getLabelValue(S[C]);
                                    for (o.isArray(v[x]) && -1 != v[x].indexOf(q) || o.runtime.tmp.updateLabelValue(S[C], null),
                            ...
                            for (C = 0; C < S.length; C++) {
                                ...
                                for (k = 0; k < S.length; k++)
                                    if ((R = S[k].getAttribute("data-product-option-id")) != x)
                                        for (D = S[k].getElementsByClassName("ladi-form-label-item"),
                                        N = 0; N < D.length; N++)
            ...
            T = 0; T < S.length; T++) {
                ...
                if (!o.isEmpty(V))
                    o.findAncestor(S[T], "ladi-element").getAttribute("data-title-type") == o.const.PRODUCT_VARIANT_TITLE.top && (V = ": " + V);
                var H = o.findAncestor(S[T], "ladi-form-item-box");
                o.isEmpty(H) || (H = H.querySelector(".ladi-form-item-title-value"),
        ...
        if (a.isArray(n.product.variants) && 0 != n.product.variants.length) {
            ...
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combined)
                for (s = 0; s < o.length; s++)
                    d = o[s].querySelector('option[data-product-variant-id="' + l.product_variant_id + '"]'),
                    a.isEmpty(d) || (o[s].value = d.getAttribute("value"),
            ...
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combobox && a.isString(l.option_ids) && l.option_ids.split("/").forEach(function(t, e) {
                for (s = 0; s < o.length; s++)
                    o[s].getAttribute("data-product-option-id") == t && (o[s].value = l["option" + (e + 1)] || "",
                    a.fireEvent(o[s], "change"))
            }),
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.label && a.isString(l.option_ids) && l.option_ids.split("/").forEach(function(t, e) {
                for (s = 0; s < r.length; s++)
                    r[s].getAttribute("data-product-option-id") == t && (a.runtime.tmp.updateLabelValue(r[s], l["option" + (e + 1)] || ""),
    ...
    0 == n.length)
        ...
        n.forEach(function(e, n) {
            if (!(e.quantity <= 0)) {
                ...
                r += '<tr class="ladi-cart-row' + (a.isObject(e.promotion) ? " has-promotion" : "") + '"><td class="ladi-cart-image"><img src="' + s + '" />',
                ...
                a.isObject(e.promotion) && (r += '<span class="promotion-name">' + e.promotion.discount.note + "</span>"),
                r += "</td>",
                ...
                r += '<td class="ladi-cart-price"><span' + (a.isNull(e.store_id) ? "" : ' data-store-id="' + e.store_id + '"') + ' data-product-id="' + e.product_id + '" data-product-variant-id="' + e.product_variant_id + '" data-cart-item-key="' + e.cart_item_key + '">';
                var l = e.price * e.quantity
                  , d = a.formatNumber(l, 3);
                a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (d = a.formatCurrency(l, e.currency.symbol, !0)),
                r += d + "</span>",
                a.isObject(e.promotion) && (l = e.promotion.total,
                d = a.formatNumber(l, 3),
                a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (d = a.formatCurrency(l, e.currency.symbol, !0)),
                r += '<span class="price-compare">' + d + "</span>"),
                r += "</td>",
    ...
    if (!this.isEmpty(a)) {
        ...
        if (!this.isEmpty(o) && (o["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.combobox || o["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.label)) {
            ...
            for (var c = 0; c < l.length; c++)
                d[l[c].getAttribute("data-product-option-id")] = (n.isEmpty(l[c].value) ? "" : l[c].value).trim();
            for (l = a.querySelectorAll(".ladi-form-label-container[data-product-option-id]"),
            c = 0; c < l.length; c++)
                d[l[c].getAttribute("data-product-option-id")] = n.runtime.tmp.getLabelValue(l[c]).trim();
                ...
                if (n.isEmpty(i)) {
                    ...
                    if (n.isString(t.option_ids))
                        for (var a = t.option_ids.split("/"), o = 0; o < a.length; o++)
                            if (d[a[o].trim()] != (t["option" + (o + 1)] || "").trim()) {
                                e = !1;
                                break
                            }
...
LadiPageScriptV2.prototype.getProductVariantIndex = function(t, e) {
    ...
    if (!i.isObject(s) || !i.isObject(s.store_info) || !i.isObject(s.product) || !i.isArray(s.product.variants) || s.product.variants.length <= 0)
        return a;
            ...
            if ("form" == l.type && l["option.is_add_to_cart"] && l["option.product_type"] == n && l["option.product_id"] == r && l["option.ladisale_store_id"] == o) {
                ...
                if (!i.isEmpty(d)) {
                    ...
                    if (!i.isEmpty(c)) {
                        ...
                        if (!i.isEmpty(p)) {
                            var u = null;
                            if (p["option.product_variant_type"] == i.const.PRODUCT_VARIANT_TYPE.combobox && (u = c.querySelectorAll(".ladi-form-item select[data-product-option-id]"),
                            ...
                            p["option.product_variant_type"] == i.const.PRODUCT_VARIANT_TYPE.label && (u = c.querySelectorAll(".ladi-form-label-container[data-product-option-id]"),
                            a = s.product.variants.findIndex(function(t) {
                                for (var e = !0, a = null, n = function(t) {
                                    return t == a
                                }, o = 0; o < u.length; o++)
                            ...
                            p["option.product_variant_type"] == i.const.PRODUCT_VARIANT_TYPE.combined) {
                                ...
                                if (i.isEmpty(m) || m.getAttribute("data-store-id") != s.store_info.id || m.getAttribute("data-product-id") != s.product.product_id)
                                    return;
                                a = m.value,
                                a = i.isEmpty(a) ? -1 : parseInt(a)
                            }
                        }
                    }
                }
    ...
    if (l.isObject(p) && l.isObject(p.product)) {
        ...
        var g = function() {
            if (-1 != [l.const.FORM_CONFIG_TYPE.ladisales, l.const.FORM_CONFIG_TYPE.sapo, l.const.FORM_CONFIG_TYPE.haravan, l.const.FORM_CONFIG_TYPE.shopify, l.const.FORM_CONFIG_TYPE.wordpress].indexOf(d)) {
                if (-1 != ["name", "description", "content", "location", "timezone", "external_link"].indexOf(c) && (_ = p.product[c],
                e = _),
                ...
                if (-1 != ["image"].indexOf(c) && (_ = p.product[c],
                l.isObject(_) && (e = _.src,
                l.isEmpty(e) || !l.isString(e) || e.startsWith("http://") || e.startsWith("https://") || e.startsWith("//") || (e = "https://" + l.const.STATIC_W_DOMAIN + "/" + e))),
                -1 != ["images"].indexOf(c) && (_ = p.product[c],
                l.isArray(_) && (e = [],
                _.forEach(function(t) {
                ...
                l.isArray(p.product.variants) && p.product.variants.length > 0) {
                    ...
                    -1 != t) {
                        ...
                        -1 != ["variant_start_date", "variant_end_date"].indexOf(c)) {
                            ...
                            _ = r[c] || r.product_name,
                            e = _;
                        else if (-1 != ["text_quantity"].indexOf(c))
                            _ = 1 == r.inventory_checked ? r[c] : "",
                            e = _;
                        else if (-1 != ["weight"].indexOf(c))
                            _ = r[c],
                            l.isEmpty(r.weight_unit) || (_ += r.weight_unit),
                            e = _;
                        else if (-1 != ["price", "compare_price"].indexOf(c))
                            l.isEmpty(r[c]) ? _ = "" : (_ = l.formatNumber(r[c], 3),
                            l.isObject(p.store_info) && l.isObject(p.store_info.currency) && !l.isEmpty(p.store_info.currency.symbol) && (_ = l.formatCurrency(r[c], p.store_info.currency.symbol, !0))),
                            e = _;
                        else if (-1 != ["price_sale"].indexOf(c)) {
                            var f = 0;
                            l.isEmpty(r.price) || l.isEmpty(r.compare_price) || (f = r.compare_price - r.price),
                            0 != f ? (_ = l.formatNumber(f, 3),
                            l.isObject(p.store_info) && l.isObject(p.store_info.currency) && !l.isEmpty(p.store_info.currency.symbol) && (_ = l.formatCurrency(f, p.store_info.currency.symbol, !0))) : _ = "",
                            e = _
                        } else if (-1 != ["price_sale_percent"].indexOf(c)) {
                            var h = 0;
                            l.isEmpty(r.price) || l.isEmpty(r.compare_price) || (h = Math.floor((r.compare_price - r.price) / r.compare_price * 100)),
                            e = _ = 0 != h ? h + "%" : ""
                            ...
                            l.isEmpty(_))
                                return c = "image",
                                g();
                            !l.isString(_) || _.startsWith("http://") || _.startsWith("https://") || _.startsWith("//") || (_ = "https://" + l.const.STATIC_W_DOMAIN + "/" + _),
                            e = _
                        } else
...
LadiPageScriptV2.prototype.generateVariantProduct = function(t, e, i, a, n, o, r, s, l) {
    var d = e ? "" : null
      ...
      , p = function(t) {
        if (!e)
            return c.isObject(t) ? t : null;
        var s = "";
        if (c.isObject(t)) {
            if (!c.isObject(t.product))
                return s;
            ...
            c.runtime.isClient && (s += '<option value="" data-product-variant-id="">' + c.const.LANG.OPTION_NO_SELECT + "</option>"),
            c.isArray(t.product.variants) && t.product.variants.forEach(function(e, i) {
                var a = e.title || e.product_name;
                if (n) {
                    var o = c.formatNumber(e.price, 3);
                    c.isObject(t.store_info) && c.isObject(t.store_info.currency) && !c.isEmpty(t.store_info.currency.symbol) && (o = c.formatCurrency(e.price, t.store_info.currency.symbol, !0)),
                    a += " - " + o
                }
                s += '<option value="' + i + '" data-product-variant-id="' + e.product_variant_id + '">' + a + "</option>"
            }),
            s += "</select></div></div>"),
            i == c.const.PRODUCT_VARIANT_TYPE.combobox && c.isArray(t.product.options) && t.product.options.forEach(function(e) {
                if (e.is_tmp)
                    s += '<div class="ladi-form-item-box"></div>';
                else if (c.isArray(e.values) && 0 != e.values.length) {
                    s += '<div class="ladi-form-item-box">',
                    c.isEmpty(a) || (s += '<div class="ladi-form-item-title"><span>' + e.name + "</span></div>"),
                    s += '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select' + (c.isObject(t.store_info) && !c.isNull(t.store_info.id) ? ' data-store-id="' + t.store_info.id + '"' : "") + ' data-product-id="' + e.product_id + '" data-product-option-id="' + e.product_option_id + '" required tabindex="' + o + '" class="ladi-form-control ladi-form-control-select" data-selected=""' + (r ? "" : ' onmousedown="javascript: event.preventDefault();"') + ">",
                    c.runtime.isClient && (s += '<option value="">' + c.const.LANG.OPTION_NO_SELECT + "</option>");
                    var i = null;
            ...
            i == c.const.PRODUCT_VARIANT_TYPE.label && c.isArray(t.product.options) && t.product.options.forEach(function(e) {
                if (c.isArray(e.values) && 0 != e.values.length) {
                    s += '<div class="ladi-form-item-box">',
                    c.isEmpty(a) || (s += '<div class="ladi-form-item-title">',
                    s += "<span>" + e.name + "</span>",
                    s += '<span class="ladi-form-item-title-value">' + (r ? "" : e.values[0].name) + "</span>",
                    s += "</div>"),
                    s += '<div class="ladi-form-label-container"' + (c.isObject(t.store_info) && !c.isNull(t.store_info.id) ? ' data-store-id="' + t.store_info.id + '"' : "") + ' data-product-id="' + e.product_id + '" data-product-option-id="' + e.product_option_id + '" data-selected="">';
                    var i = null;
                    c.isArray(t.product.variants) && (i = t.product.variants[0]);
                    var n = null;
                    c.isEmpty(i) || c.isString(i.option_ids) && (n = i.option_ids.split("/"));
                    e.values.forEach(function(t, a) {
                        ...
                        if (t.type == c.const.PRODUCT_VARIANT_OPTION_TYPE.image) {
                            var r = t.value;
                            c.isEmpty(r) || !c.isString(r) || r.startsWith("http://") || r.startsWith("https://") || r.startsWith("//") || (r = "https://" + c.const.STATIC_W_DOMAIN + "/" + r),
                            r = c.getOptimizeImage(r, 100, 100, !1, !1, !1, !0),
                            s += '<div class="ladi-form-label-item image' + o + '" style=\'background-image: url("' + r + '");\' title="' + (t.name_new || t.name) + '" data-value="' + t.name + '"></div>'
                        } else
                            t.type == c.const.PRODUCT_VARIANT_OPTION_TYPE.color ? s += '<div class="ladi-form-label-item color' + o + "\" style='background-color: " + t.value + ";' title=\"" + (t.name_new || t.name) + '" data-value="' + t.name + '"></div>' : s += '<div class="ladi-form-label-item text' + o + '" data-value="' + t.name + '">' + (t.name_new || t.name) + "</div>"
                    }),
                    s += "</div></div>"
                }
            })
    ...
    if (!c.isNull(t.dataProduct))
        return p(t.dataProduct);
    ...
    if (-1 != [c.const.FORM_CONFIG_TYPE.ladisales, c.const.FORM_CONFIG_TYPE.sapo, c.const.FORM_CONFIG_TYPE.haravan, c.const.FORM_CONFIG_TYPE.shopify, c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m)) {
        if (!c.isEmpty(y)) {
            if (c.isEmpty(c.runtime.tmp.product_info[m]) && (c.runtime.tmp.product_info[m] = {}),
            c.isEmpty(c.runtime.tmp.timeout_product_info[m]) && (c.runtime.tmp.timeout_product_info[m] = {}),
            y = parseInt(y) || y,
            E = c.runtime.tmp.product_info[m][y],
            P = function() {
                return p(E)
            }
            ,
            c.isNull(E)) {
                ...
                var L = function() {
                    c.runtime.tmp.product_info[m][y] = !1,
                    c.isEmpty(c.runtime.tmp.timeout_product_info[m][y]) || (c.removeTimeout(c.runtime.tmp.timeout_product_info[m][y]),
                    delete c.runtime.tmp.timeout_product_info[m][y])
                }
                  , A = function(t) {
                    if (E = c.isObject(c.runtime.tmp.product_info[m][y]) ? c.runtime.tmp.product_info[m][y] : t.data,
                    c.isObject(E)) {
                        if (!c.isObject(E.store_info)) {
                            var e = c.runtime.currency;
                            c.runtime.isClient || (e = LadiPage.getRootScope().getStoreCurrency()),
                            E.store_info = {
                                currency: {
                                    code: e,
                        ...
                        c.isObject(E.product) && c.isArray(E.product.options) && c.isArray(E.product.variants)) {
                            var i = E.product.options.map(function(t) {
                                return t.product_option_id
                            });
                            i = i.join("/");
                            for (var a = 0; a < E.product.variants.length; a++)
                                -1 != [c.const.FORM_CONFIG_TYPE.ladisales].indexOf(m) && 1 == E.product.variants[a].allow_sold_out && (E.product.variants[a].inventory_checked = 0),
                                c.isNull(E.product.variants[a].compare_price) && (E.product.variants[a].compare_price = E.product.variants[a].price_compare),
                                c.isNull(E.product.variants[a].variant_start_date) && (E.product.variants[a].variant_start_date = E.product.variants[a].start_date),
                                c.isNull(E.product.variants[a].variant_end_date) && (E.product.variants[a].variant_end_date = E.product.variants[a].end_date),
                                c.isNull(E.product.variants[a].variant_timezone) && (E.product.variants[a].variant_timezone = E.product.variants[a].timezone),
                                c.isEmpty(E.product.variants[a].option_ids) && (E.product.variants[a].option_ids = i),
                                -1 != [c.const.FORM_CONFIG_TYPE.sapo, c.const.FORM_CONFIG_TYPE.haravan, c.const.FORM_CONFIG_TYPE.shopify].indexOf(m) && 1 == E.product.variants.length && "Default Title" == E.product.variants[a].title && (E.product.variants[a].title = null,
                                E.product.variants[a].option1 = null,
                                E.product.options = []),
                                -1 != [c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m) && 1 == E.product.variants.length && E.product.variants[a].title == E.product.variants[a].product_name && (E.product.variants[a].title = null,
                                E.product.variants[a].option1 = null,
                                E.product.options = []),
                                c.isEmpty(E.product.variants[a].package_quantity) || c.isEmpty(E.product.variants[a].package_quantity_unit) || (c.isNull(E.product.variants[a].title_old) && (E.product.variants[a].title_old = E.product.variants[a].title),
                            ...
                            if (c.isArray(E.product.options) && 1 == E.product.options.length && c.isArray(E.product.options[0].values))
                                for (var n = null, o = function(t) {
                                    ...
                                    E.product.options[0].values[r].name_new = E.product.options[0].values[r].label || E.product.options[0].values[r].name,
                                    c.isEmpty(s) || c.isEmpty(s.package_quantity) || c.isEmpty(s.package_quantity_unit) || (E.product.options[0].values[r].name_new = E.product.options[0].values[r].name_new + " (" + s.package_quantity + " " + s.package_quantity_unit + ")")
                                }
                        }
                        c.runtime.tmp.product_info[m][y] = E,
                        d = P(),
                        c.isFunction(l) && l(d)
                    } else
                        L()
                ...
                return c.runLimitRequest(20, function() {
                    if (c.runtime.isClient) {
                        ...
                        b = JSON.stringify(b)) : m == c.const.FORM_CONFIG_TYPE.wordpress ? (S = "GET",
                        t = window.location.origin + "/ladipage/api?action=product_info&product_id=" + y,
                        b = null) : (w = {
                            "Content-Type": "application/json"
                        },
        ...
        ,
        c.isNull(E))
            return c.runtime.tmp.product_info[m][y] = !0,
            c.loadDataset(g, g, f, h, v, !0, c.runtime.isClient, function(t) {
                d = P(),
                c.isFunction(l) && l(d)
            }),
            d;
...
LadiPageScriptV2.prototype.generateVariantContentString = function(t, e, i, a) {
    ...
    i = this.isEmpty(i) ? " | " : i;
    try {
        this.isEmpty(t) || (e && (t = Base64.decode(t)),
        t = JSON.parse(t),
...
LadiPageScriptV2.prototype.reloadFeeShipping = function(t) {
    ...
    var a = function(t, i) {
        ...
        e.changeTotalPriceCart(),
        e.isNull(i) && (e.runtime.tmp.add_to_cart_shipping_method_id = null,
        i = []);
        for (var a = null, n = e.runtime.tmp.add_to_cart_shipping_method_id, o = function(t) {
            ...
            for ("true" != l.getAttribute("data-event") && (l.setAttribute("data-event", !0),
            l.addEventListener("change", o)),
            e.isNull(l.getAttribute("data-placeholder")) && l.setAttribute("data-placeholder", d[0].innerHTML); d.length > 0; )
                d[0].parentElement.removeChild(d[0]);
            i.length <= 0 && ((a = document.createElement("option")).innerHTML = l.getAttribute("data-placeholder"),
            l.appendChild(a));
    ...
    e.runtime.tmp.timeout_reload_fee_shipping = e.runTimeout(function() {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var n = null;
            if (n = e.isEmpty(t) ? document.getElementById(e.runtime.tmp.list_form_checkout[0]) : e.findAncestor(t.target, "ladi-form"),
            e.isEmpty(n))
                a(0);
            else {
                ...
                if (e.isEmpty(o) || e.isEmpty(r) || e.isEmpty(s))
                    a(0);
                else {
                    var l = o.value
                      , d = r.value
                      , c = s.value;
                    if (e.isEmpty(l) || e.isEmpty(d))
                        return void a(0);
                    var p = {
                        state_id: l.split(":")[0],
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.sapo)
                        return m = function(t, n) {
                            ...
                            e.sendRequest("POST", window.location.origin + t.getAttribute("action"), u, !0, _, function(t, n, o) {
                                    ...
                                    if (200 == n)
                                        try {
                                            for (var r = 0, s = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shipping_rate_id_"]'), p = 0; p < c.length; p++) {
                                                ...
                                                e.isEmpty(y) || (u = y.textContent.trim()),
                                                y = c[p].querySelector("span.content-box-emphasis"),
                        ...
                        if (n.readyState == XMLHttpRequest.DONE) {
                            if (200 == i)
                                try {
                                    ...
                                    if (200 == o.code) {
                                        var r = 0;
                                        if (e.isArray(o.data.shipping_methods))
...
LadiPageScriptV2.prototype.getThirdPartyCheckoutUrl = function(t, e) {
    ...
    -1 != [i.const.FORM_CONFIG_TYPE.ladisales].indexOf(i.runtime.shopping_product_type) && (i.isNull(i.runtime.shopping_config_checkout_id) ? (a = i.runtime.tmp.ladisales_checkout_url,
    ...
    t.getCheckoutSapo(null, function(e, i) {
        ...
        if (!t.isEmpty(n)) {
            ...
            if (!t.isEmpty(r)) {
                ...
                t.isEmpty(s) || (s.value = n.textContent.trim(),
        ...
        if (!t.isEmpty(n)) {
            ...
            if (!t.isEmpty(o)) {
                ...
                if (!t.isEmpty(s)) {
                    ...
                    t.isEmpty(l) || (l.value = o.getAttribute("data-coupon"),
...
LadiPageScriptV2.prototype.reloadPriceDiscount = function(t) {
    ...
    var i = e.runtime.tmp.current_use_coupon
      , a = function(n, o) {
        ...
        e.isEmpty(s) || (r = e.findAncestor(s, "ladi-form"),
        s.parentElement.removeChild(s));
        var l = document.querySelector('.ladi-form-item input[name="coupon"].pointer-events-none');
        if (e.isEmpty(l) || l.classList.remove("pointer-events-none"),
        !e.isEmpty(e.runtime.tmp.current_use_coupon)) {
            if (e.isEmpty(r) && !e.isEmpty(t) && (r = e.findAncestor(t.target, "ladi-form")),
            e.isEmpty(r))
                return;
        ...
        if ((i != e.runtime.tmp.current_use_coupon || e.isEmpty(t) || !t.isRemoveCoupon || !e.isEmpty(t.docCrawl)) && e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) {
            ...
            !e.isEmpty(e.runtime.tmp.current_use_coupon)) {
                ...
                if (!e.isEmpty(d))
                    d = (parseFloatLadiPage(d.getAttribute("data-checkout-subtotal-price-target")) || 0) / 100,
                    e.changeTotalPriceCart(!0).cart_price != d && (e.runtime.tmp.use_cart_line_price_original = !0)
            }
            e.updateCartPromotion()
        }
    };
    e.isEmpty(t) || e.isEmpty(t.discount_price) ? e.runtime.tmp.is_click_check_price_discount || e.isEmpty(t) && e.isEmpty(e.runtime.tmp.current_use_coupon) || (e.isEmpty(e.runtime.tmp.timeout_reload_price_discount) || e.removeTimeout(e.runtime.tmp.timeout_reload_price_discount),
    e.runtime.tmp.timeout_reload_price_discount = e.runTimeout(function() {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var i = null;
            if (e.isEmpty(t) ? i = document.getElementById(e.runtime.tmp.list_form_checkout[0]) : (i = e.findAncestor(t.target, "ladi-form"),
            e.isEmpty(i) || (i = i.querySelector("[data-submit-form-id]"),
            e.isEmpty(i) || (i = document.getElementById(i.getAttribute("data-submit-form-id"))))),
            e.isEmpty(i))
                a(0);
            else {
                var n = null
                ...
                if (e.isEmpty(s))
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.sapo)
                        return p = function(i, o) {
                            ...
                            e.sendRequest("POST", window.location.origin + i.getAttribute("action"), u, !0, c, function(i, n, o) {
                                if (o.readyState == XMLHttpRequest.DONE) {
                                    if (200 == n)
                                        try {
                                            var r = 0
                                    ...
                                    e.isEmpty(t) || e.showMessage(e.const.LANG.REQUEST_SEND_ERROR),
                                    a(0)
                                }
                            })
                        }
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan)
                        return p = function(i) {
                            ...
                            e.isEmpty(n.discount_code) ? o.search = o.search + (e.isEmpty(o.search) ? "?" : "&") + "form_name=form_discount_remove" : o.search = o.search + (e.isEmpty(o.search) ? "?" : "&") + "discount.code=" + n.discount_code + "&form_name=form_discount_add",
                            i = o.href,
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.wordpress) {
                        ...
                        return e.isEmpty(n.discount_code) ? m += "?action=remove_coupon&coupon=" + (e.isEmpty(t) ? "" : t.couponOld) : m += "?action=apply_coupon&coupon=" + n.discount_code,
                            ...
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n)
                                    try {
                                        var r = JSON.parse(i);
                                        if (200 == r.code)
                                            return e.runtime.tmp.current_use_coupon = d,
                                            void a(r.data);
                        ...
                        if (o.readyState == XMLHttpRequest.DONE) {
                            if (200 == n)
                                try {
                                    var r = JSON.parse(i);
                                    if (200 == r.code)
                                        return e.isEmpty(r.data.discount_error) ? e.runtime.tmp.current_use_coupon = d : e.isEmpty(t) || e.showMessage(r.data.discount_error),
...
LadiPageScriptV2.prototype.updateCartPromotion = function(t, e, i) {
    var a = this
            ...
            if (i.product_id == t.product_id && i.product_variant_id == t.product_variant_id) {
                ...
                for (var n = document.querySelectorAll('.ladi-cart .ladi-cart-row .ladi-cart-price span[data-product-variant-id="' + i.product_variant_id + '"]'), o = 0; o < n.length; o++) {
                    ...
                    if (a.isObject(i.promotion)) {
                        ...
                        a.isEmpty(d) && ((d = document.createElement("span")).className = "price-compare",
                        s.appendChild(d));
                        ...
                        d.innerHTML = p,
                        a.isEmpty(c) && ((c = document.createElement("span")).className = "promotion-name",
                        l.appendChild(c)),
      ...
      , r = o()
      , s = JSON.stringify(r);
    if (a.isObject(a.runtime.tmp.info_update_cart_promotion) || (a.runtime.tmp.info_update_cart_promotion = {}),
    !a.isEmpty(t)) {
        var l = []
        ...
        return -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && t.items.forEach(function(t) {
            ...
            -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && (e = {
                store_id: -1,
                product_id: t.product_id,
            ...
            a.runtime.isClient || (i = LadiPage.getRootScope().getStoreCurrency()),
            e.currency = {
                code: i,
            ...
            if (-1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type)) {
                if (e.price = t.price_original,
                a.isObject(t.properties)) {
                    var s = Object.keys(t.properties);
                    s.length > 0 && (o = t.properties[s[0]],
                    -1 != [a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && ((o = o.split("-")).shift(),
                    o = (o = o.join("-")).trim()),
                    r = {
                        product_id: t.product_id,
                        product_variant_id: t.variant_id,
            ...
            -1 != [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (e.price = t.original_price,
            t.original_line_price != t.line_price && a.isArray(t.discounts) && t.discounts.length > 0 && (o = t.discounts[0].title,
            r = {
                product_id: t.product_id,
                product_variant_id: t.variant_id,
            ...
            e.promotion = r,
            l.push(r))),
            -1 != [a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (e.price = e.price / 100,
            a.isEmpty(e.promotion) || (e.promotion.total = e.promotion.total / 100,
        ...
        -1 != [a.const.FORM_CONFIG_TYPE.wordpress].indexOf(a.runtime.shopping_product_type) && t.data.forEach(function(t) {
            ...
            a.runtime.isClient || (n = LadiPage.getRootScope().getStoreCurrency()),
            i.currency = {
                code: n,
    ...
    if (!0 !== a.runtime.tmp.info_update_cart_promotion[s]) {
        if (a.isArray(a.runtime.tmp.info_update_cart_promotion[s]))
            return a.runtime.tmp.info_update_cart_promotion[s].forEach(n),
            void a.changeTotalPriceCart();
        if (a.runtime.tmp.info_update_cart_promotion[s] = !0,
        -1 == [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type))
            if (-1 == [a.const.FORM_CONFIG_TYPE.wordpress].indexOf(a.runtime.shopping_product_type)) {
                ...
                a.isEmpty(c) || (p["cart-token"] = c),
                a.sendRequest("POST", a.const.API_LADISALE_PROMOTION, JSON.stringify(r), !0, p, function(t, e, o) {
                    if (o.readyState == XMLHttpRequest.DONE) {
                        if (200 == e)
                            try {
                                var r = JSON.parse(t);
                                if (200 == r.code && a.isObject(r.data) && a.isArray(r.data.variants))
                                    return r.data.variants.forEach(n),
                                    a.runtime.tmp.info_update_cart_promotion[s] = r.data.variants,
...
LadiPageScriptV2.prototype.addCartCookie = function(t, e, i, a, n) {
    ...
    if (-1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type))
        return -1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && ((l = new FormData).append("variantId", e.product_variant_id),
        l.append("quantity", e.quantity)),
        -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (s = {
        ...
        l = Object.keys(l).reduce(function(t, e) {
            return t.push(e + "=" + encodeURIComponent(l[e])),
            t
        }, []).join("&")),
        -1 != [o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type) && (s = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
        l = {
...
LadiPageScriptV2.prototype.updateCartCookie = function(t, e, i, a, n) {
    ...
    if (-1 == [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) {
        if (-1 != [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type))
            return d = window.location.origin + "/ladipage/api?action=cart_update_item_qty&cart_item_key=" + t.cart_item_key + "&qty=" + t.quantity,
            e && (d = 0 == t.quantity ? window.location.origin + "/ladipage/api?action=cart_empty" : window.location.origin + "/ladipage/api?action=cart_update_item_qty&qty=" + t.quantity),
        ...
        if (-1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (d = window.location.origin + "/cart/change.js",
        (s = new FormData).append("variantId", t.product_variant_id),
        s.append("quantity", t.quantity)),
        -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (d = window.location.origin + "/cart/update.js",
        l = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
...
LadiPageScriptV2.prototype.getMessageNameProduct = function(t, e) {
    ...
    return this.isObject(t) && (t.product_type == this.const.PRODUCT_TYPE.event ? i = this.const.LANG.TICKET : t.product_type == this.const.PRODUCT_TYPE.service && (i = this.const.LANG.SERVICE)),
    e || (i = i.toLowerCase()),
    i
}
,
LadiPageScriptV2.prototype.loadCollectionData = function(t, e, i, a, n) {
    ...
    if (!o.isEmpty(c) && "collection" == c.type) {
        var p = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE
          , u = c[p + ".option.collection_setting.row"]
          , m = c[p + ".option.collection_setting.column"]
          , _ = function(t, e, i, a, n, r) {
            ...
            a["option.input_type"] == o.const.INPUT_TYPE.product_variant) {
                                ...
                                for (var d = l.querySelectorAll('[data-variant="true"]'), c = 0; c < d.length; c++)
                                    if (d[c].id != s.id) {
                                        var p = o.runtime.eventData[d[c].id]
                                          ...
                                          , _ = null
                                          , y = 0;
                                        if (p["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox && (m = n.variants[a],
                                        o.isObject(m) && o.isString(m.option_ids)))
                                            for (_ = m.option_ids.split("/"),
                                            y = 0; y < _.length; y++)
                                                u = d[c].querySelector('select[data-product-option-id="' + _[y] + '"]'),
                                                o.isEmpty(u) || (u.value = m["option" + (y + 1)]);
                                        if (p["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label && (m = n.variants[a],
                                        o.isObject(m) && o.isString(m.option_ids)))
                                            for (_ = m.option_ids.split("/"),
                                            y = 0; y < _.length; y++)
                                                u = d[c].querySelector('.ladi-form-label-container[data-product-option-id="' + _[y] + '"]'),
                                                o.isEmpty(u) || o.runtime.tmp.updateLabelValue(u, m["option" + (y + 1)]);
                                        if (p["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combined) {
                                            if (u = d[c].querySelector("select.ladi-form-control"),
                                            !o.isEmpty(i)) {
                ...
                o.showParentVisibility(e, function() {
                    for (var t = e.clientHeight, n = t, r = e.querySelectorAll("select.ladi-form-control"), m = {}, _ = 0; _ < r.length; _++)
                        m[r[_].getAttribute("data-store-id") + "_" + r[_].getAttribute("data-product-id") + "_" + r[_].getAttribute("data-product-option-id")] = r[_].value;
                    var y = e.querySelectorAll(".ladi-form-label-container");
                    for (_ = 0; _ < y.length; _++)
                        m[y[_].getAttribute("data-store-id") + "_" + y[_].getAttribute("data-product-id") + "_" + y[_].getAttribute("data-product-option-id")] = p(y[_]);
                    e.innerHTML = s;
                    for (var g = e.querySelectorAll("select.ladi-form-control"), f = null, h = null, v = 0; v < g.length; v++)
                        ...
                        o.isNull(f) && (h = g[v].querySelector("option"),
                        o.isEmpty(h) || (f = h.getAttribute("value"))),
                        g[v].value = f;
                    ...
                    n > 0 && t != n)) {
                        ...
                        o.isEmpty(A) || (A = o.findAncestor(A, "ladi-element"),
                    ...
                    if (!o.isEmpty(t.target.value)) {
                        ...
                        if (!(o.isEmpty(e) || o.isEmpty(e.store_info) || o.isEmpty(e.product))) {
                            ...
                            if (-1 != r) {
                                ...
                                c > d + u && (d = c - u),
                                1 == e.product.variants[r].inventory_checked && d + u > s && (d = s - u),
                                !o.isEmpty(p) && d + u > p && (d = p - u),
                                d = d < 1 ? 1 : d,
            ...
            if ("button" == a.type && (a["option.is_buy_now"] || a["option.is_add_to_cart"])) {
                var h = function() {
                    ...
                    if (!o.isArray(t) && (t = [],
                    o.isObject(i["option.data_action"]))) {
          ...
          , y = function(t, e, i, a, n, r) {
            ...
            var p = e.type
              , u = null
              , m = null;
            if (s && "headline" == p && (m = t.getElementsByClassName("ladi-headline")[0],
            o.isEmpty(m) || (m.innerHTML = o.isNull(d) ? "" : d)),
            s && "paragraph" == p && (m = t.getElementsByClassName("ladi-paragraph")[0],
            o.isEmpty(m) || (m.innerHTML = o.isNull(d) ? "" : d)),
            s && "image" == p) {
            ...
            if ("gallery" == p) {
                ...
                s) {
                    ...
                    for (var L = t.getElementsByClassName("ladi-gallery-control-item"), A = function(e) {
                        ...
                        t.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(b)
                    }
                    ...
                    for (var w = t.querySelectorAll(".ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow"), S = 0; S < w.length; S++)
                        d.length <= 1 ? w[S].style.setProperty("display", "none") : w[S].style.removeProperty("display");
                    for (w = t.querySelectorAll(".ladi-gallery > .ladi-gallery-control"),
                    S = 0; S < w.length; S++)
                        d.length <= 1 ? w[S].style.setProperty("display", "none") : w[S].style.removeProperty("display");
                    for (w = t.querySelectorAll(".ladi-gallery > .ladi-gallery-view"),
                    S = 0; S < w.length; S++)
                        d.length <= 1 ? w[S].style.setProperty("height", "100%") : w[S].style.removeProperty("height");
                    d.forEach(function(e, i) {
                        u = e.src,
                        o.isEmpty(h) || (u = o.getOptimizeImage(e.src, h.clientWidth, h.clientHeight, !0, !1, !1, o.runtime.isClient));
                        var a = t.querySelector('.ladi-gallery .ladi-gallery-view-item[data-index="' + i + '"]');
                        o.isEmpty(a) || a.style.setProperty("background-image", 'url("' + u + '")'),
                        o.isEmpty(f) || (u = o.getOptimizeImage(e.src, f.clientWidth, f.clientHeight, !0, !1, !1, o.runtime.isClient)),
            ...
            "countdown_item" == p && o.runtime.tmp.runOptionCountdownItem(t.id, t, p, e["option.countdown_item_type"]),
            "countdown" == p && o.runtime.tmp.runOptionCountdown(t.id, t, p, e["option.countdown_type"], e["option.countdown_minute"], e["option.countdown_daily_start"], e["option.countdown_daily_end"], e["option.countdown_endtime"])
        }
          , g = function(t, e) {
            var c = u * m
            ...
            if (o.isObject(p) && o.isArray(p.products)) {
                ...
                if (!o.isEmpty(p.total_record) && i * c >= p.total_record) {
                    ...
                    f.setAttribute("data-max-page", h),
                    v = !0
                }
                ...
                if (o.isEmpty(P) || P.classList.remove("opacity-0"),
                o.isEmpty(L) || L.classList.remove("opacity-0"),
                o.isEmpty(A) || A.classList.remove("opacity-0"),
                1 == f.getAttribute("data-page") && d == o.const.COLLECTION_TYPE.carousel && (o.isEmpty(P) || P.classList.add("opacity-0")),
                f.getAttribute("data-page") == f.getAttribute("data-max-page") && (d == o.const.COLLECTION_TYPE.readmore && (o.isEmpty(A) || A.classList.add("opacity-0")),
                d == o.const.COLLECTION_TYPE.carousel && (o.isEmpty(L) || L.classList.add("opacity-0"))),
                h < i)
                    return;
                ...
                var R = function(t, i, a, n, d, c) {
                    ...
                    for (var p = function(t, e) {
                        ...
                        a && (o.isFunction(o.runtime.tmp.runOptionAction) && o.runtime.tmp.runOptionAction(t[u], t[u].id, m.type, m),
                        o.isFunction(o.runtime.tmp.runOptionHover) && o.runtime.tmp.runOptionHover(t[u], t[u].id, m.type, m["option.data_event"] || m["option.data_hover"]),
                        _(t, t[u], e, m, i, R)),
                        y(t[u], m, n, d, a, c))
                    }
                };
                for (S = 0; S < p.products.length; S++)
                    o.isArray(p.products[S].options) && p.products[S].options.length > w && (w = p.products[S].options.length);
                for (f.setAttribute("data-max-option-length", w),
                S = 0; S < p.products.length; S++)
                    if (!(D.length > S)) {
                        var F = document.createElement("div");
                        F.className = N.className,
                        x.appendChild(F),
                        F.innerHTML = N.innerHTML;
                        for (var q = F.getElementsByClassName("ladi-element"); o.isArray(p.products[S].options) && p.products[S].options.length < w; )
                            p.products[S].options.push({
                                is_tmp: !0
                            });
                        R(q, p.products[S], !0, null, !1, !1)
                    }
                v && x.classList.add("last"),
                d == o.const.COLLECTION_TYPE.carousel && function(t) {
                    var e = document.getElementById(t);
                    if (!o.isEmpty(e) && e.hasAttribute("data-page")) {
                        var i = "0"
                          ...
                          , d = m - l.length
                          , c = "";
                        d > 0 ? (r > 1 && (i = r != s.length ? "calc(-" + a + " * " + (r - 1) + ")" : "calc(-" + a + " * " + (r - 1) + " + (" + a + " / " + m + " * " + d + "))"),
                        n = "calc(" + a + " * " + s.length + " - (" + a + " / " + m + " * " + d + "))",
                        c += "#" + t + " .ladi-collection-content .ladi-collection-page.last {",
                        c += "width: calc(" + getComputedStyle(e).width + " / " + m + " * " + l.length + ");",
                        c += "}") : (r > 1 && (i = "calc(-" + a + " * " + (r - 1) + ")"),
                        n = "calc(" + a + " * " + s.length + ")");
                        ...
                        _ += "}",
                        _ += c,
                        o.createStyleElement(p, _)
                    }
                }(t),
                n && d == o.const.COLLECTION_TYPE.readmore && function(t) {
                    var e = document.getElementById(t);
                    if (!o.isEmpty(e)) {
                        ...
                        if (s != l) {
                            ...
                            o.isEmpty(d) && (d = o.findAncestor(e.parentElement, "ladi-section")),
                            o.updateHeightElement(!0, e, d, s, l)
                        }
                    }
                }(t),
                o.runEventScroll(),
...
var lightbox_run = function(t, e, i, a, n, o, r, s) {
    ...
    if (!LadiPageScript.isEmpty(l)) {
        ...
        var u = document.getElementById(n)
          , m = !1;
        LadiPageScript.isEmpty(u) ? (u = document.createElement("div"),
        l.appendChild(u),
        u.outerHTML = t,
        u = l.lastChild,
        m = !0) : i && LadiPageScript.runEventReplayVideo(n, o, !0);
        var _ = document.createElement("div");
        _.className = "lightbox-close",
        _.setAttribute("data-hidden", !0),
        l.appendChild(_),
        u.setAttribute("id", n),
        u.setAttribute("data-hidden", !0),
        u.classList.remove("lightbox-hidden");
        var y = function() {
            if (u = document.getElementById(n),
            !LadiPageScript.isEmpty(u)) {
                if ("IFRAME" == u.tagName) {
                    ...
                    if (t > 0 || e > 0) {
                        var i = .8 * document.body.clientWidth
                          ...
                          , r = e / t * o;
                        r > a && (o = (r = a) * (t / e)),
                        u.style.setProperty("width", (parseFloatLadiPage(o) || 0) + "px"),
                        u.style.setProperty("height", (parseFloatLadiPage(r) || 0) + "px")
                    }
                }
                ...
                LadiPageScript.isEmpty(p) || (p.style.setProperty("width", getComputedStyle(u).width),
                p.style.setProperty("height", getComputedStyle(u).height))
            }
        }
          , g = function() {
            LadiPageScript.runTimeout(function() {
                u = document.getElementById(n),
                LadiPageScript.isEmpty(u) || (u.setAttribute("data-opacity", 0),
                u.removeAttribute("data-hidden")),
                _ = l.getElementsByClassName("lightbox-close")[0],
                LadiPageScript.isEmpty(_) || (_.setAttribute("data-opacity", 0),
        ...
        m && (u.addEventListener(f, g),
        u.addEventListener("error", g)),
        i) {
            var h = e;
            o == LadiPageScript.const.VIDEO_TYPE.youtube && (e = null,
            h = r),
            m ? LadiPageScript.runEventPlayVideo(n, o, h, !1, !1, !0, !1, s, !1, function(t) {
                LadiPageScript.isEmpty(t) ? g() : (t.addEventListener(f, g),
                t.addEventListener("error", g))
            }) : g()
        }
        s || l.style.setProperty("display", "block"),
        LadiPageScript.isEmpty(e) || (m ? u.src = e : g());
        var v = function() {
          ...
          , E = 0;
        v() ? (E = window.scrollY,
        LadiPageScript.runtime.tmp.bodyScrollY = E) : E = LadiPageScript.runtime.tmp.bodyScrollY;
        var P = function() {
            l.style.removeProperty("display"),
            u = document.getElementById(n),
            LadiPageScript.isEmpty(u) || (a && !i ? u.parentElement.removeChild(u) : (u.classList.add("lightbox-hidden"),
            ...
            var e = v();
            e && !LadiPageScript.isEmpty(LadiPageScript.runtime.tmp.bodyScrollY) && window.scrollTo(0, LadiPageScript.runtime.tmp.bodyScrollY),
        ...
        !s) {
            ...
            L += "top: -" + E + "px !important;",
            L += "}",
            LadiPageScript.createStyleElement("style_lightbox", L)
        }
        LadiPageScript.isEmpty(l.getAttribute("data-load-event")) && (l.setAttribute("data-load-event", !0),
        l.addEventListener("click", function(t) {
            t.stopPropagation(),
  ...
  , lightbox_iframe = function(t, e, i, a, n, o) {
    if (!LadiPageScript.isEmpty(t)) {
        ...
        LadiPageScript.isEmpty(d) || "IFRAME" != d.tagName || (l = d.src,
        i = d.id || i,
        d.removeAttribute("src"),
        d.setAttribute("style", r),
    ...
    if (!LadiPageScript.isEmpty(this.id)) {
        ...
        if (e && LadiPageScript.isObject(t))
            Object.keys(t).forEach(function(e) {
                ...
                LadiPageScript.isArray(a) && a.length > 1 && (a = JSON.stringify(a)),
                a = encodeURIComponent(a),
                n += e + "=" + a
            });
        if (!LadiPageScript.isEmpty(n)) {
            ...
            o.search = o.search + (LadiPageScript.isEmpty(o.search) ? "?" : "&") + n,
            a = o.href
        }
...
LadiPageLibraryV2.prototype.open_url = function(t, e) {
    if (!LadiPageScript.isEmpty(this.id))
        if (LadiPageScript.runtime.has_popupx)
            ...
            LadiPageScript.isEmpty(t) || "_self" == t.toLowerCase() ? e ? a.click() : window.location.href = i : e ? (a.setAttribute("target", t),
...
LadiPageLibraryV2.prototype.set_cookie = function(t, e, i, a, n) {
    if (!LadiPageScript.isEmpty(this.id)) {
        ...
        if (n)
            ...
            var r = new Date;
            !LadiPageScript.isNull(e) && e instanceof Date ? r = e : (e = LadiPageScript.isEmpty(e) ? 365 : e,
            r.setTime(r.getTime() + 24 * e * 60 * 60 * 1e3)),
            o = "expires = " + r.toUTCString()
        }
        t = LadiPageScript.isEmpty(t) ? "" : t;
        var s = this.id + " = " + t;
        LadiPageScript.isEmpty(o) || (s += "; " + o),
        ...
        if (LadiPageScript.runtime.has_popupx)
            ...
            for (var a = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), n = 0; n < a.length; n++)
                if (a[n].id != this.id && a[n].hasAttribute("data-popup-backdrop") && "none" != getComputedStyle(a[n]).display) {
                    ...
                    LadiPageScript.isEmpty(o) || (o = LadiPageScript.findAncestor(o, "ladi-element")),
                    (LadiPageScript.isEmpty(o) || o.id != a[n].id) && (LadiPageScript.runRemovePopup(a[n].id, !0),
                    100)
                }
            var r = LadiPageScript.isObject(LadiPageScript.runtime.story_page)
                ...
                if (0 != s) {
                    ...
                    if (u) {
                        ...
                        (m = function() {
                            _ = a(d += 20, n, s, c),
                            y(_),
                            d < c ? LadiPageScript.runtime.tmp.scroll_timeout_id = LadiPageScript.runTimeout(m, 20) : y(i)
                        }
                        )()
                }
            }
              ...
              , c = null
              , p = null;
            e ? r ? i.scrollIntoView() : (d = l(window),
            window.scrollTo({
                top: d.scrollTop
            })) : LadiPageScript.runTimeout(function() {
                var t;
                ...
                LadiPageScript.runtime.story_page.type == LadiPageScript.const.STORY_PAGE.horizontal && (t = p,
                c = {
                    scrollLeft: LadiPageScript.getElementBoundingClientRect(i).left + (r ? t.scrollLeft : t.scrollX)
                },
                s("left", p, c.scrollLeft)),
                LadiPageScript.runtime.story_page.type == LadiPageScript.const.STORY_PAGE.vertical && (d = l(p),
                s("top", p, d.scrollTop))) : (p = window,
                d = l(p),
        ...
        if (4 == l.length)
            if (LadiPageScript.isNull(t)) {
                ...
                s.forEach(function(t, e) {
                    LadiPageScript.isEmpty(l[e]) || (l[e].value = t,
            ...
            for (r = 0; r < c.length; r++)
                if (LadiPageScript.isNull(t))
                    ...
                    "date" == c[r].getAttribute("data-type") && (LadiPageScript.isEmpty(t) ? c[r].setAttribute("type", "text") : c[r].setAttribute("type", "date")));
            var h = !1;
            for (r = 0; r < p.length; r++)
                LadiPageScript.isNull(t) ? (p[r].checked && n.push(p[r].value),
                "checkbox" == p[r].getAttribute("type").toLowerCase() && (o = !0)) : (h = !1,
            ...
            for (r = 0; r < m.length; r++) {
                ...
                if (LadiPageScript.isNull(t))
                    LadiPageScript.isEmpty(L) || n.push({
                    ...
                    if (LadiPageScript.isEmpty(A))
                        LadiPageScript.playVideo(this.id, L["option.video_type"], L["option.video_value"], L["option.video_control"]);
                    else {
                        LadiPageScript.pauseAllVideo();
                        var T = !1;
                        if (L["option.video_type"] == LadiPageScript.const.VIDEO_TYPE.youtube) {
                            var O = window.YT.get(A.id);
                            !LadiPageScript.isEmpty(O) && LadiPageScript.isFunction(O.loadVideoById) && (O.loadVideoById(b, 0),
                            O.seekTo(0),
                            T = !0)
                        }
                        L["option.video_type"] == LadiPageScript.const.VIDEO_TYPE.direct && LadiPageScript.isFunction(A.play) && (A.src = t,
                        A.currentTime = 0,
                        T = !0),
            ...
            for (r = 0; r < _.length; r++)
                LadiPageScript.isNull(t) ? (_[r].classList.contains("selected") && n.push(_[r].getAttribute("data-value")),
                "true" == a.getAttribute("data-multiple") && (o = !0)) : (h = !1,
                -1 != s.indexOf(_[r].getAttribute("data-value")) && (h = !0),
                h ? _[r].classList.contains("selected") || _[r].click() : _[r].classList.contains("selected") && _[r].click())
        }
...
LadiPageLibraryV2.prototype.top = function() {
    ...
    if (!LadiPageScript.isEmpty(t) && t.classList.contains("ladi-section"))
        try {
            ...
            LadiPageScript.isEmpty(e) || e.id != LadiPageScript.runtime.builder_section_background_id || (e = e.nextElementSibling),
    ...
    if (LadiPageScript.isEmpty(t))
        ...
        if (!LadiPageScript.isEmpty(e)) {
            ...
            "tabs" == e.type) {
                ...
                return LadiPageScript.isEmpty(a) && (a = t.querySelector(".ladi-tabs > .ladi-element")),
                void (LadiPageScript.isEmpty(a) || LadiPageScript.isEmpty(a.previousElementSibling) || (a.previousElementSibling.classList.add("selected"),
    ...
    if (LadiPageScript.isEmpty(t))
        ...
        if (!LadiPageScript.isEmpty(e)) {
            ...
            "tabs" == e.type) {
                var a = t.querySelector(".ladi-tabs > .ladi-element.selected[data-index]");
                return LadiPageScript.isEmpty(a) && (a = t.querySelector(".ladi-tabs > .ladi-element")),
                void (LadiPageScript.isEmpty(a) || LadiPageScript.isEmpty(a.nextElementSibling) || (a.nextElementSibling.classList.add("selected"),
                a.classList.remove("selected"),
                LadiPageScript.reloadLazyload(!1)))
            }
            LadiPageScript.isEmpty(i) || i.click()
    ...
    if (LadiPageScript.isEmpty(e))
        ...
        if (!LadiPageScript.isEmpty(i)) {
            ...
            if ("tabs" != i.type) {
                ...
                LadiPageScript.isEmpty(o) || (LadiPageScript.isEmpty(n) || n.classList.remove("selected"),
        ...
        if (LadiPageScript.isEmpty(i)) {
            var a = LadiPageScript.isNull(t)
              ...
              , c = function(t) {
                ...
                o || (t = !1),
                LadiPageScript.runtime.list_collapse[d.id] = LadiPageScript.updateHeightElement(!0, e, i, r, s, t, LadiPageScript.runtime.list_collapse[d.id])
            };
        ...
        if (e.classList.contains("ladi-section")) {
            ...
            if (!LadiPageScript.isEmpty(i))
                for (var a = document.querySelectorAll('.ladi-section[data-tab-id="' + i + '"]'), n = 0; n < a.length; n++)
                    a[n].id == e.id ? a[n].classList.add("selected") : (a[n].classList.remove("selected"),
        ...
        if (t) {
            e.getElementsByClassName("ladi-popup").length > 0 ? (LadiPageScript.runShowPopup(!1, this.id, null, null, !0, function() {
                for (var t = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), e = 0; e < t.length; e++)
                    t[e].id != o.id && t[e].hasAttribute("data-popup-backdrop") && "none" != getComputedStyle(t[e]).display && LadiPageScript.runRemovePopup(t[e].id, !0)
            }),
            LadiPageScript.removeLazyloadPopup(this.id),
            r(),
            s(),
            LadiPageScript.runResizeSectionBackground()) : (e.style.setProperty("display", "block", "important"),
            r(),
            s(),
            LadiPageScript.runResizeSectionBackground(),
            LadiPageScript.reloadLazyload(!1))
        } else {
            if (LadiPageScript.runtime.has_popupx && LadiPageScript.runtime.tmp.showPopupX(e.id, !0))
                return;
            o.show(!0)
        }
    }
...
LadiPageLibraryV2.prototype.showDropbox = function(t, e, i) {
    ...
    if (!(LadiPageScript.isEmpty(a) || "true" != a.getAttribute("data-dropbox") || i && a.getAttribute("data-from-doc-id") == t.id && "true" != a.getAttribute("data-dropbox-backdrop") && "block" == getComputedStyle(a).display)) {
        ...
        LadiPageScript.isEmpty(a.getAttribute("data-style")) && a.removeAttribute("data-style"),
        t.setAttribute("data-style", t.getAttribute("style") || ""),
        LadiPageScript.isEmpty(t.getAttribute("data-style")) && t.removeAttribute("data-style");
        var n = a.getElementsByClassName("ladi-popup")[0];
        LadiPageScript.isEmpty(n) || (n.setAttribute("data-style", n.getAttribute("style") || ""),
        LadiPageScript.isEmpty(n.getAttribute("data-style")) && n.removeAttribute("data-style"));
        ...
        e.padding > 0 && (s += 'content: ""; position: absolute; width: 100%; height: ' + e.padding + "px; bottom: " + -e.padding + "px; left: 0;")),
        ...
        e.padding > 0 && (s += 'content: ""; position: absolute; width: 100%; height: ' + e.padding + "px; top: " + -e.padding + "px; left: 0;")),
        ...
        e.padding > 0 && (s += 'content: ""; position: absolute; width: ' + e.padding + "px; height: 100%; top: 0; right: " + -e.padding + "px;")),
        ...
        e.padding > 0 && (s += 'content: ""; position: absolute; width: ' + e.padding + "px; height: 100%; top: 0; left: " + -e.padding + "px;")),
        ...
        var l = "dropbox-" + a.id;
        if (i && !LadiPageScript.isEmpty(s))
            s = "#" + a.id + ":before {" + s + "}",
            LadiPageScript.createStyleElement(l, s);
        else {
        ...
        LadiPageScript.isEmpty(e.animation_name) || LadiPageScript.isEmpty(n) || (n.style.setProperty("animation-name", e.animation_name),
...
LadiPageLibraryV2.prototype.hideDropbox = function() {
    ...
    if (!LadiPageScript.isEmpty(t) && "true" == t.getAttribute("data-dropbox")) {
        ...
        LadiPageScript.isEmpty(e) || (e.setAttribute("style", e.getAttribute("data-style") || ""),
...
LadiPageLibraryV2.prototype.set_style = function(t, e, i) {
    ...
    if (!LadiPageScript.isEmpty(a)) {
        ...
        if (LadiPageScript.isEmpty(r)) {
            var s = {};
            LadiPageScript.isEmpty(e.color) || (s.color = e.color),
            LadiPageScript.isEmpty(e.background_color) || (s.background = "none",
            s["background-color"] = e.background_color),
            LadiPageScript.isEmpty(e.border_color) || (s["border-color"] = e.border_color),
            LadiPageScript.isEmpty(e.opacity) || (s.opacity = e.opacity / 100),
            LadiPageScript.isEmpty(e.transform_scale) || (s.transform = "scale(" + e.transform_scale / 100 + ")"),
            e.ontop && (s["z-index"] = "9000000090 !important"),
            LadiPageScript.isObject(e.custom_css) && Object.keys(e.custom_css).forEach(function(t) {
                s[t] = e.custom_css[t]
            });
            var l = []
              , d = ""
            ...
            var g = function(t) {
                for (var e = !1, o = 0; o < l.length; o++) {
                    var r = l[o];
                    if (LadiPageScript.isEmpty(r)) {
                        i && (y || (m += "#" + a.id + " {transition: all 150ms linear 0s;}")),
                        d += "#" + a.id + "." + n + " {" + t + "}",
                        e = !0;
                        break
                    }
                    if (document.querySelectorAll("#" + a.id + " > " + r).length > 0) {
                        i && (m += "#" + a.id + " > " + r + " {transition: all 150ms linear 0s;}"),
                        d += "#" + a.id + "." + n + " > " + r + " {" + t + "}",
                        e = !0;
                        break
                    }
            ...
            if (!LadiPageScript.isEmpty(u)) {
                ...
                m += f() + " {transition: all 150ms linear 0s;}"),
                d += f(n) + " {" + u + "}")
            }
            ...
            g(p) || (c += p)),
            LadiPageScript.isEmpty(c) || (l = [".ladi-group", ".ladi-popup", ".ladi-image", ".ladi-gallery", ".ladi-button", ".ladi-button-group", ".ladi-headline", ".ladi-paragraph", ".ladi-list-paragraph", ".ladi-line", ".ladi-box", ".ladi-collection", ".ladi-tabs", ".ladi-shape", ".ladi-video", ".ladi-form", ".ladi-carousel", ".ladi-html-code", ".ladi-frame", ".ladi-table", ".ladi-survey", ".ladi-combobox", ".ladi-countdown", ".ladi-notify", ".ladi-spin-lucky"],
            g(c) || (_ += c)),
            LadiPageScript.isEmpty(_) || (l = [""],
            g(_)),
            i ? LadiPageScript.createStyleElement(o, m) : LadiPageScript.createStyleElement(n, d)
        }
        i || a.classList.add(n)
    }
}
...
(LadiPageAppV2 = LadiPageAppV2 || function() {}
    ...
    return i.prototype.run = function(e, i) {
        ...
        if (p.classList.add("ladi-hidden"),
        !LadiPageScript.isEmpty(d) || !LadiPageScript.isEmpty(c)) {
            ...
            var h = function() {
                ...
                m != a && m != n && m != o || p.style.setProperty("top", -p.clientHeight - 100 + "px"),
                m != r && m != s && m != l || p.style.setProperty("bottom", -p.clientHeight - 100 + "px")
            };
            h(),
            ...
            var v = function(t) {
                ...
                var i = -1
                  , d = function() {
                    if (i + 1 < t.length) {
                        ...
                        m != a && m != n && m != o || p.style.removeProperty("top"),
                        m != r && m != s && m != l || p.style.removeProperty("bottom"),
                        f.forEach(function(t) {
              ...
              , E = function(t) {
                p.querySelector(".ladi-notify").classList.remove("ladi-hidden"),
                p.classList.add("ladi-notify-transition"),
                v(t)
            };
            LadiPageScript.isEmpty(c) || E(c),
            LadiPageScript.isEmpty(d) || LadiPageScript.sendRequest("GET", "https://docs.google.com/spreadsheets/d/" + d + "/gviz/tq?tqx=out:json", null, !0, null, function(t, e, i) {
                if (i.readyState == XMLHttpRequest.DONE && 200 == e) {
                    t = (t = t.substr(t.indexOf('"table":{') + '"table":'.length)).substr(0, t.indexOf("});"));
                    var a = JSON.parse(t)
                      , n = []
                      , o = a.cols;
                    LadiPageScript.isObject(a) && 0 == a.parsedNumHeaders && LadiPageScript.isArray(a.rows) && a.rows.length > 0 && LadiPageScript.isObject(a.rows[0]) && LadiPageScript.isArray(a.rows[0].c) && a.rows[0].c.length > 0 && (o = [],
                    ...
                    a.rows.shift()),
                    LadiPageScript.isObject(a) && LadiPageScript.isArray(a.rows) && LadiPageScript.isArray(o) && a.rows.forEach(function(t) {
                        if (LadiPageScript.isObject(t)) {
                            var e = {};
                            o.forEach(function(i, a) {
                                if (LadiPageScript.isArray(t.c)) {
                                    var n = t.c[a];
                                    LadiPageScript.isObject(i) && !LadiPageScript.isEmpty(i.label) && LadiPageScript.isObject(n) && (e["gsx$" + i.label.trim().toLowerCase()] = {
                                        $t: n.v
                                    })
                                }
                            }),
                ...
                !_)
                    if ((d = a(e)) >= l)
                        ...
                        if (LadiPageScript.isEmpty(m))
                            ...
                            "NEXT_TURN" != m.value.toUpperCase() && (d++,
                            window.ladi("_total_turn_" + e).set_cookie(d, 1));
                            LadiPageScript.runTimeout(function() {
                                "NEXT_TURN" == m.value.toUpperCase() ? LadiPageScript.isEmpty(m.text) || LadiPageScript.showMessage(m.text) : (LadiPageScript.setDataReplaceStr("coupon", m.value),
                                ...
                                r == LadiPageScript.const.GAME_RESULT_TYPE.default ? LadiPageScript.isEmpty(s) || LadiPageScript.showMessage(s) : window.ladi(r).show(),
